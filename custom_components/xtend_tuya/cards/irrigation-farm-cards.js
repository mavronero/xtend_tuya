 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,k=t=>t,S=w.trustedTypes,E=S?S.createPolicy("lit-html",{createHTML:t=>t}):void 0,A="$lit$",M=`lit$${Math.random().toFixed(9).slice(2)}$`,C="?"+M,N=`<${C}>`,z=document,L=()=>z.createComment(""),O=t=>null===t||"object"!=typeof t&&"function"!=typeof t,T=Array.isArray,P="[ \t\n\f\r]",D=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,U=/-->/g,R=/>/g,I=RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),F=/'/g,j=/"/g,H=/^(?:script|style|textarea|title)$/i,W=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),B=W(1),q=W(2),V=Symbol.for("lit-noChange"),G=Symbol.for("lit-nothing"),K=new WeakMap,J=z.createTreeWalker(z,129);function Y(t,e){if(!T(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==E?E.createHTML(e):e}const Z=(t,e)=>{const i=t.length-1,s=[];let n,a=2===e?"<svg>":3===e?"<math>":"",r=D;for(let e=0;e<i;e++){const i=t[e];let o,l,d=-1,c=0;for(;c<i.length&&(r.lastIndex=c,l=r.exec(i),null!==l);)c=r.lastIndex,r===D?"!--"===l[1]?r=U:void 0!==l[1]?r=R:void 0!==l[2]?(H.test(l[2])&&(n=RegExp("</"+l[2],"g")),r=I):void 0!==l[3]&&(r=I):r===I?">"===l[0]?(r=n??D,d=-1):void 0===l[1]?d=-2:(d=r.lastIndex-l[2].length,o=l[1],r=void 0===l[3]?I:'"'===l[3]?j:F):r===j||r===F?r=I:r===U||r===R?r=D:(r=I,n=void 0);const p=r===I&&t[e+1].startsWith("/>")?" ":"";a+=r===D?i+N:d>=0?(s.push(o),i.slice(0,d)+A+i.slice(d)+M+p):i+M+(-2===d?e:p)}return[Y(t,a+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),s]};class X{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let n=0,a=0;const r=t.length-1,o=this.parts,[l,d]=Z(t,e);if(this.el=X.createElement(l,i),J.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=J.nextNode())&&o.length<r;){if(1===s.nodeType){if(s.hasAttributes())for(const t of s.getAttributeNames())if(t.endsWith(A)){const e=d[a++],i=s.getAttribute(t).split(M),r=/([.?@])?(.*)/.exec(e);o.push({type:1,index:n,name:r[2],strings:i,ctor:"."===r[1]?st:"?"===r[1]?nt:"@"===r[1]?at:it}),s.removeAttribute(t)}else t.startsWith(M)&&(o.push({type:6,index:n}),s.removeAttribute(t));if(H.test(s.tagName)){const t=s.textContent.split(M),e=t.length-1;if(e>0){s.textContent=S?S.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],L()),J.nextNode(),o.push({type:2,index:++n});s.append(t[e],L())}}}else if(8===s.nodeType)if(s.data===C)o.push({type:2,index:n});else{let t=-1;for(;-1!==(t=s.data.indexOf(M,t+1));)o.push({type:7,index:n}),t+=M.length-1}n++}}static createElement(t,e){const i=z.createElement("template");return i.innerHTML=t,i}}function Q(t,e,i=t,s){if(e===V)return e;let n=void 0!==s?i._$Co?.[s]:i._$Cl;const a=O(e)?void 0:e._$litDirective$;return n?.constructor!==a&&(n?._$AO?.(!1),void 0===a?n=void 0:(n=new a(t),n._$AT(t,i,s)),void 0!==s?(i._$Co??=[])[s]=n:i._$Cl=n),void 0!==n&&(e=Q(t,n._$AS(t,e.values),n,s)),e}class tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??z).importNode(e,!0);J.currentNode=s;let n=J.nextNode(),a=0,r=0,o=i[0];for(;void 0!==o;){if(a===o.index){let e;2===o.type?e=new et(n,n.nextSibling,this,t):1===o.type?e=new o.ctor(n,o.name,o.strings,this,t):6===o.type&&(e=new rt(n,this,t)),this._$AV.push(e),o=i[++r]}a!==o?.index&&(n=J.nextNode(),a++)}return J.currentNode=z,s}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class et{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=G,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Q(this,t,e),O(t)?t===G||null==t||""===t?(this._$AH!==G&&this._$AR(),this._$AH=G):t!==this._$AH&&t!==V&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>T(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==G&&O(this._$AH)?this._$AA.nextSibling.data=t:this.T(z.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=X.createElement(Y(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{const t=new tt(s,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=K.get(t.strings);return void 0===e&&K.set(t.strings,e=new X(t)),e}k(t){T(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const n of t)s===e.length?e.push(i=new et(this.O(L()),this.O(L()),this,this.options)):i=e[s],i._$AI(n),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=k(t).nextSibling;k(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}let it=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,n){this.type=1,this._$AH=G,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=n,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=G}_$AI(t,e=this,i,s){const n=this.strings;let a=!1;if(void 0===n)t=Q(this,t,e,0),a=!O(t)||t!==this._$AH&&t!==V,a&&(this._$AH=t);else{const s=t;let r,o;for(t=n[0],r=0;r<n.length-1;r++)o=Q(this,s[i+r],e,r),o===V&&(o=this._$AH[r]),a||=!O(o)||o!==this._$AH[r],o===G?t=G:t!==G&&(t+=(o??"")+n[r+1]),this._$AH[r]=o}a&&!s&&this.j(t)}j(t){t===G?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}};class st extends it{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===G?void 0:t}}class nt extends it{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==G)}}class at extends it{constructor(t,e,i,s,n){super(t,e,i,s,n),this.type=5}_$AI(t,e=this){if((t=Q(this,t,e,0)??G)===V)return;const i=this._$AH,s=t===G&&i!==G||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==G&&(i===G||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class rt{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Q(this,t)}}const ot=w.litHtmlPolyfillSupport;ot?.(X,et),(w.litHtmlVersions??=[]).push("3.3.2");const lt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,ce=[["all","All"],["watering","Watering"],["attention","Attention"],["offline","Offline"]];class pe extends dt{constructor(){super(...arguments),this.sites=[],this.value=ee,this.counts={},this.statuses=!0,this.search=!0}_set(t){this.value={...this.value,...t},this.dispatchEvent(new CustomEvent("xt-filter-changed",{detail:this.value,bubbles:!0,composed:!0}))}render(){const t=[...this.sites].map(t=>({id:t.id,path:ae(this.sites,t.id)})).sort((t,e)=>t.path.localeCompare(e.path));return B`
  ...
  `],t([ut({attribute:!1})],pe.prototype,"sites",void 0),t([ut({attribute:!1})],pe.prototype,"value",void 0),t([ut({attribute:!1})],pe.prototype,"counts",void 0),t([ut({type:Boolean})],pe.prototype,"statuses",void 0),t([ut({type:Boolean})],pe.prototype,"search",void 0),customElements.get("xt-valve-filter-bar")||customElements.define("xt-valve-filter-bar",pe);function he(t,e=Date.now()){const i=jt(e),s=Math.round((jt(t)-i)/864e5);return 0===s?"Today":-1===s?"Yesterday":1===s?"Tomorrow":Bt(t,{weekday:"short",day:"numeric",month:"short"})}function ue(t){return qt(t)}function me(t){return`${he(t)} ${ue(t)}`}function ve(t,e=Date.now()){const i=Math.round((e-t)/6e4);if(i<60)return`${i} min`;const s=Math.round(i/60);return s<48?`${s} h`:`${Math.round(s/24)} d`}function ge(t){return`${Math.round(t).toLocaleString()} L`}function fe(t){return t>=95?"mdi:battery":t<10?"mdi:battery-outline":"mdi:battery-"+10*Math.floor(t/10)}function _e(t){return Math.abs(t)<1e3?`${Math.round(t)} L`:`${(t/1e3).toFixed(1)} m³`}class be extends dt{constructor(){super(...arguments),this.daily=[],this.unit="L"}render(){const t=Math.max(...this.daily,0),e=this.daily.length,i=jt(Date.now());return this.daily.map((s,n)=>B`<span
          title="${(t=>Bt(Ht(i,t-(e-1)),{weekday:"short",day:"numeric",month:"short"}))(n)}: ${Math.round(s).toLocaleString()} ${this.unit}"
  ...
  `],t([ut({attribute:!1})],be.prototype,"daily",void 0),t([ut()],be.prototype,"unit",void 0),customElements.get("xt-week-bars")||customElements.define("xt-week-bars",be);const xe={low_battery:"Low battery",stale:"No report 36 h",missed:"Missed",no_flow:"No water flow"},ye={low_battery:"Battery below 20 %",stale:"The valve has not reported for more than 36 hours",missed:"A planned run in the last 24 hours did not happen",no_flow:"The last run measured no water"};function $e(t){const e=[me(t.start),`${Math.round(t.minutes)} min`];return null!==t.liters&&e.push(`${Math.round(t.liters)} L`),e.join(" · ")}function we(t){return(t.number?t.name.replace(/\s*\(\d+\)\s*$/,""):t.name)||t.name}class ke extends dt{_open(){this.summary&&this.dispatchEvent(new CustomEvent("xt-valve-open",{detail:this.summary.view_path,bubbles:!0,composed:!0}))}_status(t){if("watering"===t.status){const e=null!==t.flow_lpm?` · ${t.flow_lpm.toFixed(1)} L/min`:"";return B`<span class="status watering" title="Watering now"><i></i>Watering${t.since?` since ${ue(t.since)}`:""}${e}</span>`}return"offline"===t.status?B`<span class="status offline" title="Not reachable"><i></i>Offline${t.since?` for ${ve(t.since)}`:""}</span>`:B`<span class="status idle" title="Online, not watering"><i></i>Idle</span>`}_week(t){const e=t.week.unit,i="L"===e?`${Math.round(t.week.liters)} L`:`${Math.round(t.week.minutes)} min`;return B`<div class="week">
      ...
      >
    </div>`}render(){const t=this.summary;if(!t)return G;const e=t.location&&t.location.name!==we(t)?t.location.name:null,i=t.location?[e,t.site?.name].filter(Boolean).join(" · "):"No location";return B`<ha-card class=${t.status} @click=${this._open} tabindex="0" role="link" aria-label=${t.name}>
      <div class="head">
        <span class="name" title=${t.name}>${we(t)}</span>
        ...
        ${null!==t.battery?B`<span class="battery ${t.badges.includes("low_battery")?"low":""}" title="Battery ${Math.round(t.battery)} %"
              ><ha-icon icon=${fe(t.battery)}></ha-icon>${Math.round(t.battery)} %</span
            >`:G}
      </div>
      ...
      <dl>
        ...
        <dd title="Last run: start · duration${t.has_flow_meter?" · water":""}">${t.last?$e(t.last):"–"}</dd>
        <dt title="Next planned run"><ha-icon icon="mdi:calendar-clock"></ha-icon></dt>
        <dd title="Next planned run: start · duration">${t.next?$e(t.next):"–"}</dd>
      </dl>
      ${this._week(t)}
      ${t.badges.length?B`<div class="badges">
            ${t.badges.map(e=>B`<span class="badge ${e}" title=${ye[e]}>${xe[e]}${"missed"===e&&t.missed>1?` ${t.missed}`:""}</span>`)}
          </div>`:G}
    </ha-card>`}}ke.styles=[de,r`
    :host {
      display: block;
    }
    ha-card {
  ...
  `],t([ut({attribute:!1})],ke.prototype,"summary",void 0),customElements.get("xt-valve-card")||customElements.define("xt-valve-card",ke);class Se extends dt{constructor(){super(...arguments),this.collapsed=!1}render(){const t=this.section;return t?B`
  ...
  `],t([ut({attribute:!1})],Se.prototype,"section",void 0),t([ut({type:Boolean,reflect:!0})],Se.prototype,"collapsed",void 0),customElements.get("xt-valve-section")||customElements.define("xt-valve-section",Se);const Ee="xt-valves-filter";class Ae extends dt{constructor(){super(...arguments),this._filter=function(){try{return{...ee,...JSON.parse(localStorage.getItem(Ee)??"{}")}}catch{return ee}}(),this._farm=new te(this)}setConfig(t){this._config=t}getCardSize(){return 12}_onFilter(t){this._filter=t.detail,function(t){try{localStorage.setItem(Ee,JSON.stringify(t))}catch{}}(t.detail)}_onOpen(t){le(t.detail)}render(){if(!this._config||!this.hass)return G;if(!this._farm.loaded)return B`<ha-card><div class="msg">Loading valves…</div></ha-card>`;const t=this._farm.summaries(),e=this._farm.data,i=this._config.site??null,s={...this._filter,site:i??this._filter.site},n=oe(t,{...s,status:"all"},e.sites),a={};for(const t of["all","watering","attention","offline"])a[t]="all"===t?n.length:oe(n,{...ee,status:t},e.sites).length;const r=function(t,e,i=se){const s=(t,e)=>t.name.localeCompare(e.name),n=(t,e)=>({key:t,title:ie[t],groups:[{site:null,title:"",valves:[...e].sort(s)}],count:e.length}),a=t.filter(t=>"offline"!==t.status),r=a.filter(t=>t.location),o=new Map;for(const t of r){const e=t.site?.id??null;o.set(e,[...o.get(e)??[],t])}const l=[...o.entries()].map(([t,i])=>({site:t,title:t?ae(e,t):"No site",valves:i.sort(s)})).sort((t,e)=>null===t.site?1:null===e.site?-1:t.title.localeCompare(e.title)),d={watering:n("watering",a.filter(t=>"watering"===t.status)),attention:n("attention",a.filter(re)),sites:{key:"sites",title:ie.sites,groups:l,count:r.length},offline:n("offline",t.filter(t=>"offline"===t.status)),unassigned:n("unassigned",a.filter(t=>!t.location))};return i.map(t=>d[t]).filter(t=>t.count>0)}(oe(n,{...ee,status:s.status},e.sites),e.sites,this._config.sections??se),o=new Set(this._config.collapsed??["offline"]);return B`
  ...
  `],t([ut({attribute:!1})],Le.prototype,"summary",void 0),customElements.get("xt-site-card")||customElements.define("xt-site-card",Le);class Oe extends dt{constructor(){super(...arguments),this.sites=[],this.selected=null,this.counts={},this.noSite=!1,this._closed=new Set}_open(t){this.dispatchEvent(new CustomEvent("xt-site-open",{detail:t,bubbles:!0,composed:!0}))}_toggle(t,e){t.stopPropagation();const i=new Set(this._closed);i.has(e)?i.delete(e):i.add(e),this._closed=i}_node(t,e){const i=Ce(this.sites,t.id),s=this._closed.has(t.id);return B`
      <button
    ...
    `}render(){return B`
      ...
      ${Ce(this.sites,null).map(t=>this._node(t,0))}
      ${this.noSite?B`<button class="node ${this.selected===Me?"on":""}" @click=${()=>this._open(Me)}>
            <span class="chev"></span><span class="label dim">No site</span>
            <span class="count">${this.counts[Me]??""}</span>
          </button>`:G}
    `}}Oe.styles=[de,r`
    :host {
      display: flex;
  ...
  `],t([ut({attribute:!1})],Oe.prototype,"sites",void 0),t([ut({attribute:!1})],Oe.prototype,"selected",void 0),t([ut({attribute:!1})],Oe.prototype,"counts",void 0),t([ut({type:Boolean})],Oe.prototype,"noSite",void 0),t([mt()],Oe.prototype,"_closed",void 0),customElements.get("xt-site-tree")||customElements.define("xt-site-tree",Oe);const Te={no_valve:["No valve","No valve is assigned to this metering point","warn"],low_battery:["Low battery","The valve's battery is below 20 %","warn"],stale:["No report 36 h","The valve has not reported for more than 36 hours","warn"],missed:["Missed","A planned run in the last 24 hours did not happen","bad"],no_flow:["No water flow","The last run here measured no water","bad"],flow_low:["Flow low","Mean flow of the last 30 days is well below the expected L/min","bad"],flow_high:["Flow high","Mean flow of the last 30 days is well above the expected L/min (leak?)","bad"]},Pe={watering:"Watering",idle:"Idle",offline:"Offline"};function De(t){const e=[me(t.start),`${Math.round(t.minutes)} min`];return null!==t.liters&&e.push(`${Math.round(t.liters)} L`),e.join(" · ")}class Ue extends dt{constructor(){super(...arguments),this.editable=!1}_openValve(t,e){t.stopPropagation(),this.dispatchEvent(new CustomEvent("xt-valve-open",{detail:e.view_path,bubbles:!0,composed:!0}))}_valve(t){return B`<button class="valve ${t.status}" @click=${e=>this._openValve(e,t)} title="Open valve ${t.name}">
      <ha-icon icon="mdi:valve"></ha-icon>
      <span class="num">${t.number?`#${t.number}`:t.name}</span>
      <i></i><span>${Pe[t.status]}</span>
      ...
      <dl>
        ...
        <dd title="Last run here: start · duration · water">${t.last?De(t.last):"–"}</dd>
        <dt title="Next planned run"><ha-icon icon="mdi:calendar-clock"></ha-icon></dt>
        <dd title="Next planned run: start · duration">${t.next?De(t.next):"–"}</dd>
      </dl>
      <div class="week">
        <ha-icon icon="mdi:chart-bar" title="Last 7 days"></ha-icon>
        <xt-week-bars .daily=${t.week.daily} unit=${e}></xt-week-bars>
      ...
      ${this._flow(t)}
      ${t.badges.length?B`<div class="badges">
            ${t.badges.map(e=>{const[i,s,n]=Te[e];return B`<span class="badge ${n}" title=${s}>${i}${"missed"===e&&t.missed>1?` ${t.missed}`:""}</span>`})}
          </div>`:G}
    </ha-card>`}}Ue.styles=[de,r`
    :host {
      display: block;
    }
    ha-card {
  ...
  `],t([ut({attribute:!1})],Ue.prototype,"summary",void 0),t([ut({type:Boolean})],Ue.prototype,"editable",void 0),customElements.get("xt-mp-card")||customElements.define("xt-mp-card",Ue);const Re={watering:"Watering",idle:"Idle",offline:"Offline"};function Ie(t){return Bt(t,{day:"numeric",month:"short",year:"numeric"})}class Fe extends dt{constructor(){super(...arguments),this.sites=[],this.valves=[],this.busy=!1,this.error=null}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_save(t){t.preventDefault();const e=t.target,i=t=>e.elements.namedItem(t).value,s=i("expected_lpm").trim();this._fire("xt-mp-save",{name:i("name"),description:i("description"),expected_lpm:""===s?null:Number(s),site_id:i("site_id")||null})}_valveLine(t,e){return B`<div class="valve">
      <ha-icon icon="mdi:valve"></ha-icon>
      <span class="num">${t?.label??e}</span>
      ${t?B`<i class=${t.status}></i><span>${Re[t.status]}</span>`:G}
      ${null!=t?.battery?B`<span class="dim"><ha-icon icon=${fe(t.battery)}></ha-icon>${Math.round(t.battery)} %</span>`:G}
        ...
        ${s.length?B`<section>
              ...
              <ul>
                ${s.map(t=>B`<li>
                    ...
                    <span class="dim"
                      >${t.begin?Ie(t.begin):"from the start"} – ${t.end?Ie(t.end):"now"}</span
                    >
                  </li>`)}
              </ul>
            </section>`:G}
    ...
    `],t([ut({attribute:!1})],Fe.prototype,"mp",void 0),t([ut({attribute:!1})],Fe.prototype,"sites",void 0),t([ut({attribute:!1})],Fe.prototype,"valves",void 0),t([ut({type:Boolean})],Fe.prototype,"busy",void 0),t([ut()],Fe.prototype,"error",void 0),customElements.get("xt-mp-editor")||customElements.define("xt-mp-editor",Fe);const je=r`
    :host {
      display: block;
    }
    .layout {
...
`,He="xtend_tuya/irrigation_locations";function We(){return new URLSearchParams(window.location.search).get("site")}class Be extends dt{constructor(){super(...arguments),this._selected=We(),this._edit=!1,this._editing=null,this._busy=!1,this._error=null,this._farm=new te(this),this._mpMemo=null,this._onLocation=()=>{this._selected=We()}}setConfig(t){}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),window.addEventListener("location-changed",this._onLocation),window.addEventListener("popstate",this._onLocation)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("location-changed",this._onLocation),window.removeEventListener("popstate",this._onLocation)}_open(t){const e=new URL(window.location.href);t?e.searchParams.set("site",t):e.searchParams.delete("site"),window.history.pushState(null,"",e.pathname+e.search),this._selected=t,this._error=null}async _post(t){if(!this.hass?.callApi)return!1;this._busy=!0,this._error=null;try{return await this.hass.callApi("POST",He,t),await this._farm.refresh(!0),!0}catch(t){const e=t;return this._error=e.body?.error??e.message??String(t),!1}finally{this._busy=!1}}async _createSite(t,e){const i=t.querySelector("input");i.value.trim()&&await this._post({action:"create_site",name:i.value,parent_id:e})&&(i.value="")}async _saveSite(t,e){const i=t.querySelector("input").value,s=t.querySelector("select").value||null;await this._post({action:"update_site",id:e.id,name:i,parent_id:s})}async _deleteSite(t){await this._post({action:"delete_site",id:t.id})&&this._open(t.parent_id)}_header(t,e){const i=[{id:null,name:"All sites"}];if(t&&t.id!==Me){const e=new Map(this._farm.data.sites.map(t=>[t.id,t])),s=[];for(let i=e.get(t.id);i&&s.length<20;i=i.parent_id?e.get(i.parent_id):void 0)s.unshift(i);i.push(...s.map(t=>({id:t.id,name:t.name})))}else t&&i.push({id:Me,name:"No site"});const s=i[i.length-1].name;return B`<div class="header">
      ...
      <div class="figures">
        ${t?B`
              ...
              <span title="Last 7 days"
                ><xt-week-bars .daily=${t.week.daily}></xt-week-bars>${t.week.runs} runs · ${ge(t.week.liters)}</span
              >
    ...
    ></xt-mp-editor>`}_addMp(t){return B`<form class="editor" @submit=${e=>(e.preventDefault(),this._createMp(e.target,t))}>
      ...
      <button type="submit" ?disabled=${this._busy}>Add</button>
    </form>`}render(){if(!this.hass)return G;if(!this._farm.loaded)return B`<ha-card><div class="msg">Loading sites…</div></ha-card>`;const t=this._farm.data,e=this._farm.summaries();if(this._mpMemo?.valves!==e){const i=Date.now();this._mpMemo={valves:e,list:t.locations.map(s=>ze(s,t,e,i))}}const i=this._mpMemo.list,s=new Map(i.map(t=>[t.id,t])),n=t.locations.some(t=>!t.site_id),a=this._selected&&(this._selected===Me||t.sites.some(t=>t.id===this._selected))?this._selected:null,r=a&&a!==Me?t.sites.find(t=>t.id===a)??null:null,o=a?Ne(a,t,i):null,l=a?o.children:[...Ce(t.sites,null).map(t=>t.id),...n?[Me]:[]],d=l.map(e=>Ne(e,t,i)),c=a?t.locations.filter(t=>a===Me?!t.site_id:t.site_id===a).sort((t,e)=>t.name.localeCompare(e.name)):[],p={};for(const e of t.sites)p[e.id]=t.locations.filter(i=>ne(t.sites,e.id).has(i.site_id??"")).length;p[Me]=t.locations.filter(t=>!t.site_id).length;const h=i.flatMap(t=>t.valves),u={sites:t.sites.length,mps:t.locations.length,valves:h.length,online:h.filter(t=>"offline"!==t.status).length},m=this._editing?t.locations.find(t=>t.id===this._editing):void 0;return B`<div
      class="layout"
      @xt-site-open=${t=>this._open(t.detail)}
      @xt-valve-open=${t=>le(t.detail)}
    ...
    >
      ...
      <main>
        ...
        ${d.length||this._edit&&a!==Me?B`<h3>${a?"Sub-sites":"Sites"} <span class="count">${d.length}</span></h3>
              <div class="grid">${d.map(t=>B`<xt-site-card .summary=${t}></xt-site-card>`)}</div>
              ${this._edit&&a!==Me?this._addSite(a):G}`:G}
        ${c.length||this._edit&&a?B`<h3>Metering points <span class="count">${c.length}</span></h3>
              ...
              ${this._edit&&a?this._addMp(a===Me?null:a):G}`:G}
    ...
    </div>`}}Be.styles=[de,je],t([ut({attribute:!1})],Be.prototype,"hass",void 0),t([mt()],Be.prototype,"_selected",void 0),t([mt()],Be.prototype,"_edit",void 0),t([mt()],Be.prototype,"_editing",void 0),t([mt()],Be.prototype,"_busy",void 0),t([mt()],Be.prototype,"_error",void 0),customElements.get("irrigation-sites-card")||customElements.define("irrigation-sites-card",Be);const qe=1e3;function Ve(t,e){return(null===t.begin||t.begin<=e)&&(null===t.end||e<t.end)}function Ge(t,e,i){const s=(e,s)=>t.pumpAssignments.find(t=>t.target_kind===e&&t.target_id===s&&Ve(t,i))?.pump_id??null,n=s("location",e.id);if(n)return n;const a=new Map(t.sites.map(t=>[t.id,t]));for(let t=e.site_id?a.get(e.site_id):void 0,i=0;t&&i<20;i++){const e=s("site",t.id);if(e)return e;t=t.parent_id?a.get(t.parent_id):void 0}return null}function Ke(t,e,i){const s=t.pumpAssignments.filter(t=>t.pump_id===e&&"site"===t.target_kind&&Ve(t,i)).map(t=>t.target_id),n=[],a=[],r=e=>{const i=new Map(t.sites.map(t=>[t.id,t]));for(let t=e.site_id?i.get(e.site_id):void 0,n=0;t&&n<20;n++){if(s.includes(t.id))return!0;t=t.parent_id?i.get(t.parent_id):void 0}return!1};for(const s of t.locations){const o=Ge(t,s,i);o===e?n.push(s.id):o&&r(s)&&a.push({mp:s.id,pump:o})}return{sites:s,mps:n,overridden:a}}function Je(t,e){const i=jt(t);return"day"===e?i:i+36e5*Math.floor(Wt(t))}function Ye(t,e,i,s,n,a,r){const o=new Map,l=t=>{const e=Je(t,a);let i=o.get(e);return i||o.set(e,i={start:e,pump:null,valves:0,consumers:0}),i},d="hour"===a?36e5:864e5;for(let t=Je(s,a);t<n;t+=d)l(t);let c=null;for(const t of i[e.meter_entity]??[]){if(t.start<s||t.start>=n||"number"!=typeof t.change||t.change<0)continue;const e=l(t.start);e.pump=(e.pump??0)+t.change*qe,c=(c??0)+t.change*qe}let p=0;for(const i of t.runs){const a=Date.parse(i.end);if(a<s||a>=n||"number"!=typeof i.liters)continue;const o=Mt(t,i.device_id,a);!o||Ge(t,o,a)!==e.id||r&&!r(o)||(p+=i.liters,l(Date.parse(i.start)).valves+=i.liters)}let h=0;for(const a of function(t,e,i,s){return t.pumpConnections.filter(t=>t.pump_id===e&&(null===t.begin||t.begin<s)&&(null===t.end||t.end>i))}(t,e.id,s,n))if("consumer"===a.role&&a.meter_entity)for(const t of i[a.meter_entity]??[])t.start<s||t.start>=n||"number"!=typeof t.change||t.change<0||!Ve(a,t.start)||(h+=t.change*qe,l(t.start).consumers+=t.change*qe);return{pump:c,valves:p,consumers:h,unaccounted:null===c?null:c-p-h,buckets:[...o.values()].sort((t,e)=>t.start-e.start)}}const Ze="__no_pump__";class Xe extends dt{constructor(){super(...arguments),this.items=[],this.selected=null}render(){return this.items.map(t=>B`<button
        class="node ${t.id===this.selected?"on":""}"
        aria-current=${t.id===this.selected?"page":"false"}
        @click=${()=>this.dispatchEvent(new CustomEvent("xt-pump-open",{detail:t.id,bubbles:!0,composed:!0}))}
      >
        ${t.id===Ze?B`<span class="dot none"></span>`:B`<span class="dot ${t.state}" title=${"unknown"===t.state?"No data from the pump":t.state}></span>`}
        <span class="label ${t.id===Ze?"dim":""}">${t.name}</span>
        <span class="count">${t.count}</span>
      </button>`)}}Xe.styles=[de,r`
      :host {
        display: flex;
        flex-direction: column;
        gap: 1px;
    ...
    `],t([ut({attribute:!1})],Xe.prototype,"items",void 0),t([ut({attribute:!1})],Xe.prototype,"selected",void 0),customElements.get("xt-pump-list")||customElements.define("xt-pump-list",Xe);const Qe=160;class ti extends dt{constructor(){super(...arguments),this.buckets=[],this.period="hour"}_label(t){return"hour"===this.period?qt(t):Bt(t,{weekday:"short",day:"numeric"})}render(){const t=this.buckets.length;if(!t)return G;const e=Math.max(1,...this.buckets.map(t=>Math.max(t.pump??0,t.valves+t.consumers))),i=100/t,s=t=>t/e*142,n=Math.ceil(t/8);return B`
      <svg viewBox="0 0 100 ${Qe}" preserveAspectRatio="none" role="img" aria-label="Pump delivery against valve and consumer use">
        ${this.buckets.map((t,e)=>{const n=e*i,a=t.valves+t.consumers,r=`${this._label(t.start)}: pump ${null===t.pump?"no data":_e(t.pump)}, valves ${_e(t.valves)}${t.consumers?`, consumers ${_e(t.consumers)}`:""}${null!==t.pump?`, unaccounted ${_e(t.pump-a)}`:""}`;return q`<g>
            <title>${r}</title>
    ...
    `],t([ut({attribute:!1})],ti.prototype,"buckets",void 0),t([ut()],ti.prototype,"period",void 0),customElements.get("xt-pump-chart")||customElements.define("xt-pump-chart",ti);class ei extends dt{constructor(){super(...arguments),this.devices=[],this.exclude=[],this.placeholder="Search devices by name, area or model",this._q=""}render(){const t=this._q.trim().toLowerCase(),e=t?this.devices.filter(t=>!this.exclude.includes(t.id)).filter(e=>[e.name,e.area,e.model].some(e=>e?.toLowerCase().includes(t))).slice(0,30):[];return B`
    ...
    `}_pick(t){this._q="",this.dispatchEvent(new CustomEvent("xt-device-picked",{detail:t,bubbles:!0,composed:!0}))}}ei.styles=[de,r`
      :host {
        display: flex;
        flex-direction: column;
        gap: 4px;
    ...
    `],t([ut({attribute:!1})],ei.prototype,"devices",void 0),t([ut({attribute:!1})],ei.prototype,"exclude",void 0),t([ut()],ei.prototype,"placeholder",void 0),t([mt()],ei.prototype,"_q",void 0),customElements.get("xt-device-picker")||customElements.define("xt-device-picker",ei);const ii={"24h":{ms:864e5,period:"hour"},"7d":{ms:6048e5,period:"day"},"30d":{ms:2592e6,period:"day"}},si="xt-pumps-range",ni=["meter_entity","flow_entity","pressure_entity","status_entity"],ai={meter_entity:"Water meter (m³ total)",flow_entity:"Flow rate",pressure_entity:"Pressure",status_entity:"Status"},ri={meter_entity:/_fct_total_delivered_flow_mc$/,flow_entity:/_vf_flowliter$/,pressure_entity:/_vp_pressurebar$/,status_entity:/_pumpstatus$/};function oi(){return new URLSearchParams(window.location.search).get("pump")}class li extends dt{constructor(){super(...arguments),this._selected=oi(),this._range=function(){try{const t=localStorage.getItem(si);return t&&t in ii?t:"7d"}catch{return"7d"}}(),this._stats={},this._site=null,this._edit=!1,this._busy=!1,this._error=null,this._connecting=null,this._statsKey="",this._farm=new te(this),this._balanceMemo=null,this._mpMemo=null,this._onLocation=()=>{this._selected=oi()}}setConfig(t){}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),window.addEventListener("location-changed",this._onLocation),window.addEventListener("popstate",this._onLocation)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("location-changed",this._onLocation),window.removeEventListener("popstate",this._onLocation)}updated(){const t=`${this._range}|${this._farm.data.pumps.length}|${this._farm.data.pumpConnections.length}`;this.hass?.callApi&&this._farm.loaded&&t!==this._statsKey&&(this._statsKey=t,this._loadStats())}async _loadStats(){const{ms:t}=ii[this._range],e=new Date(Date.now()-t).toISOString();try{const t=await this.hass.callApi("GET",`xtend_tuya/pump_stats?period=hour&start=${encodeURIComponent(e)}`);this._stats=t.series??{}}catch(t){this._error=`Could not load pump statistics: ${t instanceof Error?t.message:String(t)}`}}_state(t){return t?this.hass?.states[t]:void 0}_num(t){const e=this._state(t),i=Number(e?.state);return e&&""!==e.state&&Number.isFinite(i)?i:null}_pumpState(t){const e=this._state(t.status_entity)?.state,i=this._num(t.flow_entity),s=this._state(t.meter_entity)?.state;return s&&"unknown"!==s&&"unavailable"!==s?"Go"===e||null!==i&&i>0?"running":"idle":"unknown"}_devices(){const t=this.hass?.areas??{};return Object.values(this.hass?.devices??{}).map(e=>({id:e.id,name:e.name_by_user||e.name||e.id,area:e.area_id?t[e.area_id]?.name??null:null,model:e.model??null}))}_deviceName(t){const e=this.hass?.devices[t];return e&&(e.name_by_user||e.name)||t}_sensorsOf(t){return t&&this.hass?Object.values(this.hass.entities).filter(e=>e.device_id===t&&e.entity_id.startsWith("sensor.")).map(t=>t.entity_id).sort():[]}_deviceOf(t){return t?this.hass?.entities[t]?.device_id??null:null}_open(t){const e=new URL(window.location.href);t?e.searchParams.set("pump",t):e.searchParams.delete("pump"),window.history.pushState(null,"",e.pathname+e.search),this._selected=t,this._error=null,this._connecting=null}_setRange(t){this._range=t;try{localStorage.setItem(si,t)}catch{}}async _post(t){if(!this.hass?.callApi)return null;this._busy=!0,this._error=null;try{const e=await this.hass.callApi("POST","xtend_tuya/irrigation_locations",t);return await this._farm.refresh(!0),this._statsKey="",e}catch(t){const e=t;return this._error=e.body?.error??e.message??String(t),null}finally{this._busy=!1}}async _createPump(t){const e=this._sensorsOf(t),i=t=>e.find(e=>ri[t].test(e))??null,s=i("meter_entity");if(!s)return void(this._error=`${this._deviceName(t)} has no water meter sensor (…_fct_total_delivered_flow_mc). Create the pump from its meter's device.`);const n=await this._post({action:"create_pump",name:this._deviceName(t),meter_entity:s,flow_entity:i("flow_entity"),pressure_entity:i("pressure_entity"),status_entity:i("status_entity")}),a=n?.pump;a&&this._open(a.id)}_savePump(t,e){t.preventDefault();const i=t.target,s=t=>i.elements.namedItem(t).value,n={action:"update_pump",id:e.id,name:s("name")};for(const t of ni)n[t]=s(t)||null;this._post(n)}_assign(t,e){t.preventDefault();const i=t.target.querySelector("select"),[s,n]=i.value.split(":");n&&this._post({action:"assign_pump",pump_id:e.id,target_kind:s,target_id:n})}_connect(t,e){t.preventDefault();const i=t.target,s=t=>i.elements.namedItem(t).value;this._post({action:"connect_device",pump_id:e.id,device_id:this._connecting,role:s("role"),meter_entity:s("meter_entity")||null}).then(t=>{t&&(this._connecting=null)})}_figures(t,e){const i=this._num(t.flow_entity),s=this._num(t.pressure_entity),n=this._state(t.status_entity)?.state,a=this._pumpState(t);return B`<div class="figures">
      ...
      >
    </div>`}_inSite(){if(!this._site)return;const t=ne(this._farm.data.sites,this._site);return e=>!!e.site_id&&t.has(e.site_id)}_balance(t){const{ms:e,period:i}=ii[this._range],s=`${t.id}|${this._range}|${this._site}|${Math.floor(Date.now()/6e4)}`,n=this._balanceMemo;if(!n||n.key!==s||n.data!==this._farm.data||n.stats!==this._stats){const n=Date.now();this._balanceMemo={key:s,data:this._farm.data,stats:this._stats,value:Ye(this._farm.data,t,this._stats,n-e,n,i,this._inSite())}}const a=this._balanceMemo.value,r=t=>a.pump?` · ${Math.round(t/a.pump*100)} %`:"",o=this._site?ae(this._farm.data.sites,this._site):null;return B`<section>
      <div class="section-head">
        <h3>Water balance</h3>
        <div class="chips" role="group" aria-label="Range">
          ${Object.keys(ii).map(t=>B`<button class=${t===this._range?"on":""} @click=${()=>this._setRange(t)}>${t}</button>`)}
        </div>
      </div>
      <div class="tiles">
        <div title="What the pump's meter counted"><span class="dim">Pump delivered</span><b>${null===a.pump?"no data":_e(a.pump)}</b></div>
        <div title="Runs of the valves this pump fed at the time${o?`, in ${o}`:""}">
          <span class="dim">${o?`Valves in ${o}`:"Valves"}</span><b>${_e(a.valves)}</b><span class="dim">${r(a.valves)}</span>
        </div>
        <div title="Metered devices connected as consumers"><span class="dim">Metered consumers</span><b>${_e(a.consumers)}</b><span class="dim">${r(a.consumers)}</span></div>
      ...
      ${d.map(t=>0===t.mps.length&&this._site?G:B`<div class="group">
      ...
      ${c.length?B`<div class="group"><span>Assigned directly</span><span class="dim">${c.length}</span></div>
            <div class="grid">${c.map(o)}</div>`:G}
      ${r.overridden.length?B`<div class="group"><span>Overridden</span><span class="dim">in these sites, fed by another pump</span></div>
            <ul class="plain">
              ${r.overridden.map(t=>{return B`<li>
    ...
    </section>`}_assignForm(t){const e=this._farm.data,i=e.sites.map(t=>({v:`site:${t.id}`,l:ae(e.sites,t.id)})).sort((t,e)=>t.l.localeCompare(e.l)),s=e.locations.map(t=>({v:`location:${t.id}`,l:t.name})).sort((t,e)=>t.l.localeCompare(e.l));return B`<form class="editor" @submit=${e=>this._assign(e,t)}>
      <label
        >Assign this pump to
        <select>
    ...
    </form>`}_valveDevices(){return this._farm.valves.map(t=>this.hass?.entities[t.registry_entity]?.device_id).filter(t=>!!t)}_pumpForm(t){const e=this._deviceOf(t.meter_entity),i=[...new Set([...this._sensorsOf(e),...ni.map(e=>t[e]).filter(t=>!!t)])].sort();return B`<form class="editor" @submit=${e=>this._savePump(e,t)}>
      <label>Name <input name="name" .value=${t.name} required /></label>
      ${ni.map(e=>B`<label
          >${ai[e]}
          <select name=${e}>
      ...
      <button type="submit" ?disabled=${this._busy}>Save</button>
    </form>`}render(){if(!this.hass)return G;if(!this._farm.loaded)return B`<ha-card><div class="msg">Loading pumps…</div></ha-card>`;const t=this._farm.data,e=Date.now(),i=this._farm.summaries();this._mpMemo?.valves!==i&&(this._mpMemo={valves:i,map:new Map(t.locations.map(s=>[s.id,ze(s,t,i,e)]))});const s=this._mpMemo.map,n=t.locations.filter(t=>!t.pump),a=[...t.pumps].sort((t,e)=>t.name.localeCompare(e.name)).map(i=>({id:i.id,name:i.name,state:this._pumpState(i),count:Ke(t,i.id,e).mps.length}));n.length&&a.push({id:Ze,name:"No pump",state:"unknown",count:n.length});const r=this._selected&&a.some(t=>t.id===this._selected)?this._selected:a[0]?.id??null,o=r&&r!==Ze?t.pumps.find(t=>t.id===r)??null:null,l=!!this.hass.user?.is_admin,d=o?Ke(t,o.id,e).mps:[],c=d.reduce((t,e)=>t+(s.get(e)?.valves.length??0),0);return B`<div
      class="layout"
    ...
    >
      ...
      <main>
        <div class="title-row">
          <h2>${o?o.name:r===Ze?"No pump":"Pumps"}</h2>
        ...
        ${r===Ze?B`<p class="dim">Metering points no pump feeds: set a pump on their site or on them.</p>
              <div class="grid">${n.map(t=>B`<xt-mp-card .summary=${s.get(t.id)}></xt-mp-card>`)}</div>`:G}
      </main>
    </div>`}}li.styles=[de,je,r`
      section {
        margin-top: 24px;
      }
      .section-head {
    ...
    `],t([ut({attribute:!1})],li.prototype,"hass",void 0),t([mt()],li.prototype,"_selected",void 0),t([mt()],li.prototype,"_range",void 0),t([mt()],li.prototype,"_stats",void 0),t([mt()],li.prototype,"_site",void 0),t([mt()],li.prototype,"_edit",void 0),t([mt()],li.prototype,"_busy",void 0),t([mt()],li.prototype,"_error",void 0),t([mt()],li.prototype,"_connecting",void 0),customElements.get("irrigation-pumps-card")||customElements.define("irrigation-pumps-card",li);class di extends dt{constructor(){super(...arguments),this.runs=[],this.metered=!0,this._shown=15}render(){const t=[...this.runs].sort((t,e)=>Date.parse(e.start)-Date.parse(t.start));return t.length?B`
      <table>
        <thead>
          <tr>
            <th>Date</th>
    ...
    `:B`<div class="empty">No runs recorded in the last 30 days.</div>`}}di.styles=[de,r`
      :host {
        display: block;
      }
      table {
    ...
    `],t([ut({attribute:!1})],di.prototype,"runs",void 0),t([ut({type:Boolean})],di.prototype,"metered",void 0),t([mt()],di.prototype,"_shown",void 0),customElements.get("xt-run-history")||customElements.define("xt-run-history",di);class ci extends dt{constructor(){super(...arguments),this._data=$t,this._loaded=!1}setConfig(t){if(!t.device_id)throw new Error("device_id is required");this._config=t}getCardSize(){return 6}updated(){this.hass&&!this._loaded&&(this._loaded=!0,kt(this.hass).then(t=>this._data=t,()=>{}))}render(){if(!this._config)return G;const t=this._data.runs.filter(t=>t.device_id===this._config.device_id);return B`<ha-card>
  ...
  `,t([ut({attribute:!1})],ci.prototype,"hass",void 0),t([mt()],ci.prototype,"_config",void 0),t([mt()],ci.prototype,"_data",void 0),t([mt()],ci.prototype,"_loaded",void 0),customElements.get("irrigation-run-history-card")||customElements.define("irrigation-run-history-card",ci);class pi extends dt{connectedCallback(){super.connectedCallback(),this.setAttribute("role","progressbar"),this.setAttribute("aria-label","Loading")}}pi.styles=[de,r`
      :host {
        display: inline-block;
        width: 18px;
        height: 18px;
    ...
    `],customElements.get("xt-spinner")||customElements.define("xt-spinner",pi);const hi={low_battery:["Low battery","Battery below 20 %","warn"],stale:["No report 36 h","The valve has not reported for more than 36 hours","warn"],missed:["Missed","A planned run in the last 24 hours did not happen","bad"],no_flow:["No water flow","The last run measured no water","bad"],flow_low:["Flow low","Mean flow of the last 30 days is well below the expected L/min","bad"],flow_high:["Flow high","Mean flow of the last 30 days is well above the expected L/min (leak?)","bad"]};class ui extends dt{constructor(){super(...arguments),this._farm=new te(this)}setConfig(t){if(!t.device_id)throw new Error("device_id is required");this._config=t}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;if(!this._farm.loaded)return B`<ha-card class="loading"><xt-spinner></xt-spinner></ha-card>`;const t=Date.now(),e=this._farm.summaryOf(this._config.device_id);if(!e)return B`<ha-card><div class="msg">Valve not found.</div></ha-card>`;const i=this._farm.data.locations.find(t=>t.valves.includes(e.device_id)),s=i?i.valves.map(t=>t===e.device_id?e:this._farm.summaryOf(t)).filter(t=>!!t):[],n=i?ze(i,this._farm.data,s,t):null,a=n?.week??e.week,r=n?.last??e.last,o=[...new Set([...n?.badges.filter(t=>"no_valve"!==t)??[],...e.badges])],l=e.number?e.name.replace(/\s*\(\d+\)\s*$/,""):e.name,d="watering"===e.status?B`<span class="status watering"><i></i>Watering${e.since?` since ${ue(e.since)}`:""}${null!==e.flow_lpm?` · ${e.flow_lpm.toFixed(1)} L/min`:""}</span>`:"offline"===e.status?B`<span class="status offline"><i></i>Offline${e.since?` for ${ve(e.since)}`:""}</span>`:B`<span class="status"><i></i>Idle</span>`,c="L"===a.unit?_e(a.liters):`${Math.round(a.minutes)} min`;return B`<ha-card>
      <div class="top">
        <div class="who">
          <div class="name-row">
            <h1>${l}</h1>
            ...
            ${null!==e.battery?B`<span class="battery ${e.badges.includes("low_battery")?"low":""}" title="Battery ${Math.round(e.battery)} %"
                  ><ha-icon icon=${fe(e.battery)}></ha-icon>${Math.round(e.battery)} %</span
                >`:G}
          </div>
          ${d}
          <div class="where">
          ...
          ${o.length?B`<div class="badges">
                ${o.map(t=>{const[e,i,s]=hi[t]??[t,t,"warn"];return B`<span class="badge ${s}" title=${i}>${e}</span>`})}
              </div>`:G}
        </div>
        <div class="tiles">
    ...
    `],t([ut({attribute:!1})],ui.prototype,"hass",void 0),t([mt()],ui.prototype,"_config",void 0),customElements.get("irrigation-valve-header-card")||customElements.define("irrigation-valve-header-card",ui);const mi=864e5,vi=36e5,gi="xt-irrigation-calendar-mode",fi="xt-irrigation-calendar-range",_i=t=>new Date(jt(t.getTime())),bi=t=>{return new Date(Ht(e=t.getTime(),-(Rt(e).weekday+6)%7));var e},xi=(t,e)=>new Date(Ht(t.getTime(),e)),yi=t=>String(t).padStart(2,"0"),$i=t=>{const e=Rt(t);return`${yi(e.hour)}:${yi(e.minute)}`},wi=t=>t>0?String(Math.round(t/6e4)):"–";function ki(t){const e=/·\s*~?([\d.,]+)\s*L\s*$/.exec(t);return e?Number(e[1].replace(",",".")):null}function Si(t){return("ran"===t.kind||"unplanned"===t.kind)&&0===t.liters}const Ei="xt-irrigation-calendar-filter";function Ai(t,e){try{return localStorage.getItem(t)??e}catch{return e}}function Mi(t,e){try{localStorage.setItem(t,e)}catch{}}class Ci extends dt{constructor(){super(...arguments),this._config=null,this._mode=["day","week","timeline"].includes(Ai(gi,"day"))?Ai(gi,"day"):"day",this._range=[1,3,7].includes(Number(Ai(fi,"1")))?Number(Ai(fi,"1")):1,this._anchor=_i(new Date),this._events=[],this._problemsOnly=!1,this._filter=function(){try{return{...ee,...JSON.parse(localStorage.getItem(Ei)??"{}"),status:"all"}}catch{return ee}}(),this._farm=$t,this._farmLoaded=!1,this._found=null,this._foundAt=0,this._offline=new Map,this._loading=!1,this._error=null,this._loadedKey=""}setConfig(t){this._config=t;const e=this._modes();e.includes(this._mode)||(this._mode=e[0])}_modes(){const t=(this._config?.modes??[]).filter(t=>["day","week","timeline"].includes(t));return t.length?t:["day","week","timeline"]}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),this._timer=window.setInterval(()=>this._load(!0),3e5)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&window.clearInterval(this._timer)}updated(){Tt(this.hass),!this._farmLoaded&&this.hass?.callApi&&(this._farmLoaded=!0,kt(this.hass).then(t=>this._farm=t,()=>{}));const t=`${this._mode}|${this._range}|${this._anchor.getTime()}`;t!==this._loadedKey&&this.hass?.callApi&&(this._loadedKey=t,this._load())}_window(){if("week"===this._mode){const t=bi(this._anchor);return[t,xi(t,7)]}const t=_i(this._anchor);return[t,xi(t,"timeline"===this._mode?this._range:1)]}_valves(){if(this._config?.valves?.length)return this._config.valves;const t=this.hass;return t?.entities&&(!this._found||Date.now()-this._foundAt>6e4)&&(this._found=bt(t).map(t=>({device_id:t.device_id,registry_entity:t.registry_entity,valve_name:t.valve_name,view_path:t.view_path,home:t.valve_home,room:t.valve_room,battery:t.battery_level??null})),this._foundAt=Date.now()),this._found??[]}_valveByRegistry(){const t=new Map;for(const e of this._valves())t.set(e.registry_entity,e);return t}async _load(t=!1){if(!this.hass?.callApi)return;const[e,i]=this._window();"timeline"===this._mode&&this._loadOffline(e,i);const s=`?start=${encodeURIComponent(e.toISOString())}&end=${encodeURIComponent(i.toISOString())}`,n=this._config?.planned_entity??"calendar.irrigation_planned",a=this._config?.completed_entity??"calendar.irrigation_completed";t||(this._loading=!0),this._error=null;try{const[t,e]=await Promise.all([this.hass.callApi("GET",`calendars/${n}${s}`),this.hass.callApi("GET",`calendars/${a}${s}`)]),i=this._valveByRegistry(),r=(t,e)=>{const s=Date.parse(t.start.dateTime??t.start.date??"");let n=Date.parse(t.end.dateTime??t.end.date??"");if(!Number.isFinite(s))return null;(!Number.isFinite(n)||n<=s)&&(n=s+6e4);const a=(t.uid??"").split("#")[0],r=i.get(a);return{start:s,end:n,kind:e,key:a,name:r?.valve_name??t.summary.split(" · ")[0],summary:t.summary,liters:"planned"===e?null:ki(t.summary),path:r?.view_path}},o=(e??[]).map(t=>r(t,/Type: In progress/.test(t.description??"")?"running":"ran")).filter(t=>!!t),l=(t??[]).map(t=>r(t,"planned")).filter(t=>!!t);this._events=Nt(l,o,Date.now())}catch(t){this._error=function(t){const e=t;return e?.body?.message??e?.message??String(t)}(t)}finally{this._loading=!1,t||this.updateComplete.then(()=>this._scrollToFirst())}}async _loadOffline(t,e){const i=this._valves().map(t=>t.registry_entity),s=new Map;for(let n=0;n<i.length;n+=40){const a=i.slice(n,n+40);try{const i=await this.hass.callApi("GET",`history/period/${encodeURIComponent(t.toISOString())}?end_time=${encodeURIComponent(e.toISOString())}&filter_entity_id=${a.join(",")}&minimal_response&no_attributes`);for(const n of i??[]){const i=n[0]?.entity_id;i&&s.set(i,Lt(n,t.getTime(),Math.min(e.getTime(),Date.now())))}}catch{}}this._offline=s}_scrollToFirst(){if("timeline"===this._mode)return;const[t,e]=this._window();let i=null;for(const s of this._events){if(s.end<=t.getTime()||s.start>=e.getTime())continue;const n=Wt(Math.max(s.start,t.getTime()));(null===i||n<i)&&(i=n)}const s=this.renderRoot.querySelector(".scroll");s&&null!==i&&(s.scrollTop=Math.max(0,(i-1)*this._hourPx()))}_hourPx(){return this._config?.hour_height??Math.max(36,Math.round(.72*window.innerHeight/8))}_setMode(t){this._mode=t,Mi(gi,t)}_setRange(t){this._range=t,Mi(fi,String(t))}_shift(t){const e="week"===this._mode?7:"timeline"===this._mode?this._range:1;this._anchor=xi(this._anchor,e*t)}_open(t){if(!t)return;const e=window.location.pathname.split("/")[1]||"lovelace";window.history.pushState(null,"",`/${e}/${t}`),this.dispatchEvent(new Event("location-changed",{bubbles:!0,composed:!0}))}_rangeLabel(){const[t,e]=this._window(),i={weekday:"short",day:"numeric",month:"short"};return e.getTime()-t.getTime()<=9e7?Bt(t.getTime(),i):`${Bt(t.getTime(),{day:"numeric",month:"short"})} – ${Bt(xi(e,-1).getTime(),i)}`}_placeOf(t){const e=this._farm.locationOf[t.device_id],i=e?.site_id??null;return{site:i,siteName:i?ae(this._farm.sites,i):null,mp:e?.name??null}}_visible(){const t=this._filter,e=t.site?ne(this._farm.sites,t.site):null,i=t.search.trim().toLowerCase();return this._valves().filter(t=>{const s=this._placeOf(t);return!!(!e||s.site&&e.has(s.site))&&(!i||[t.valve_name,s.mp,s.siteName].some(t=>t?.toLowerCase().includes(i)))})}_shownEvents(){if(!this._filter.site&&!this._filter.search.trim())return this._events;const t=new Set(this._visible().map(t=>t.registry_entity));return this._events.filter(e=>t.has(e.key))}_onFilter(t){this._filter=t.detail;try{localStorage.setItem(Ei,JSON.stringify(t.detail))}catch{}}_legend(t){const e={planned:0,ran:0,missed:0,unplanned:0,running:0,dry:0};for(const i of t)e[i.kind]++,Si(i)&&e.dry++;const i=(t,e,i,s)=>B`<span class="lg" title=${s}><i class="sw ${t}"></i><b>${e}</b> ${i}</span>`;return B`<div class="legend">
      ...
      ${"timeline"===this._mode?B`<span class="lg" title="Periods the valve was not reachable (grey hatching)"><i class="sw offline"></i>offline</span>`:G}
      ...
      <ha-card>
        <div class="head">
          ...
          <div class="bar">
            ${this._modes().length>1?B`<div class="chips" role="group" aria-label="View">
            ...
            <div class="datenav">
              ...
              ${i(!1,"Today",()=>this._anchor=_i(new Date))}
            </div>
          </div>
          <xt-valve-filter-bar
    ...
    `}_online(t){const e=this.hass?.states?.[t.registry_entity]?.state;return!!e&&"unavailable"!==e&&"unknown"!==e}_battery(t){const e=t.battery?this.hass?.states?.[t.battery]?.state:void 0,i=Number(e);return e&&""!==e&&Number.isFinite(i)?Math.round(i):null}_renderTimeline(t){const[e,i]=this._window(),s=e.getTime(),n=i.getTime()-s,a=t=>(t-s)/n*100,r=Date.now(),o=new Map;for(const e of t)(o.get(e.key)??o.set(e.key,[]).get(e.key)).push(e);const l=this._visible(),d=t=>{const e=this._placeOf(t);return e.siteName??(e.mp?"No site":"No metering point")},c=new Map;for(const t of[...l].sort((t,e)=>d(t).localeCompare(d(e))||t.valve_name.localeCompare(e.valve_name)))(c.get(d(t))??c.set(d(t),[]).get(d(t))).push(t);const p=[...c.keys()],h=1===this._range?3:3===this._range?12:24,u=[];for(let t=s;t<i.getTime();t+=h*vi){const e=Rt(t).hour;u.push({left:a(t),label:h>=24||0===e&&this._range>1?Bt(t,{weekday:"short"}):`${yi(e)}`})}const m=Array.from({length:this._range-1},(t,e)=>a(s+(e+1)*mi)),v=r>s&&r<i.getTime()?a(r):null;let g=0;const f=p.map(t=>{const e=c.get(t).map(t=>{const e=o.get(t.registry_entity)??[],i=e.some(t=>"missed"===t.kind||"unplanned"===t.kind||t.end-t.start>144e5);return{v:t,evs:e,problem:i}}).filter(t=>!this._problemsOnly||t.problem);return e.length?(g+=e.length,B`
      ...
      <div class="tl">
        <div class="row header">
          <div></div>
          <div class="axis">
            ${u.map(t=>B`<span style="left:${t.left}%">${t.label}</span>`)}
          </div>
  ...
  `],t([ut({attribute:!1})],Ci.prototype,"hass",void 0),t([mt()],Ci.prototype,"_config",void 0),t([mt()],Ci.prototype,"_mode",void 0),t([mt()],Ci.prototype,"_range",void 0),t([mt()],Ci.prototype,"_anchor",void 0),t([mt()],Ci.prototype,"_events",void 0),t([mt()],Ci.prototype,"_problemsOnly",void 0),t([mt()],Ci.prototype,"_filter",void 0),t([mt()],Ci.prototype,"_farm",void 0),t([mt()],Ci.prototype,"_offline",void 0),t([mt()],Ci.prototype,"_loading",void 0),t([mt()],Ci.prototype,"_error",void 0),!customElements.get("irrigation-calendar-card")){customElements.define("irrigation-calendar-card",Ci);const t=window;t.customCards=t.customCards||[],t.customCards.some(t=>"irrigation-calendar-card"===t.type)||t.customCards.push({type:"irrigation-calendar-card",name:"Irrigation Calendar",description:"Planned, ran, missed and unplanned irrigation runs as a day grid, week grid or per-valve timeline."})}const Ni=r`
  .titlebar {
    display: flex;
    align-items: center;
    gap: 10px;
...
`;class zi extends dt{setConfig(t){this._config=t}getCardSize(){return 3}_delay(t){const e=this._config?.rain_snow_delay,i=e?this.hass?.states[e]:void 0;if(!e||!i)return;const s=i.attributes,n=Number(s.min??0),a=Number(s.max??7),r=Math.min(a,Math.max(n,Number(i.state)+t*Number(s.step??1)));this.hass.callService("number","set_value",{entity_id:e,value:r})}render(){if(!this._config||!this.hass)return G;const t=this._config.sleep_mode?this.hass.states[this._config.sleep_mode]:void 0,e=this._config.rain_snow_delay?this.hass.states[this._config.rain_snow_delay]:void 0,i=e?Number(e.state):NaN,s=t=>!t||"unavailable"===t.state||"unknown"===t.state;return B`<ha-card>
    ...
    `],t([ut({attribute:!1})],zi.prototype,"hass",void 0),t([mt()],zi.prototype,"_config",void 0),customElements.get("irrigation-valve-settings-card")||customElements.define("irrigation-valve-settings-card",zi);
