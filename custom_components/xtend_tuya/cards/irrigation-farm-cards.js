 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const dt={attribute:!0,type:String,converter:$,reflect:!1,hasChanged:b},ct=(t=dt,e,i)=>{const{kind:s,metadata:n}=i;let a=globalThis.litPropertyMetadata.get(n);if(void 0===a&&globalThis.litPropertyMetadata.set(n,a=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),a.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const n=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,n,t,!0,i)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const n=this[s];e.call(this,i),this.requestUpdate(s,n,t,!0,i)}}throw Error("Unsupported decorator location: "+s)};function pt(t){return(e,i)=>"object"==typeof i?ct(t,e,i):((t,e,i)=>{const s=e.hasOwnProperty(i);return e.constructor.createProperty(i,t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ht(t){return pt({...t,state:!0,attribute:!1})}async function ut(t){if(!t.callApi)return{};try{const e=await t.callApi("GET","xtend_tuya/valve_locations");return e?.locations??{}}catch{return{}}}const mt="irrigation_timer_registry",ft={start_time:"start_time_sensor",close_time:"end_time_sensor",end_time:"end_time_sensor",watering_mode:"mode_sensor",watering_value:"value_sensor",watering_volume:"volume_sensor",watering_flow_rate:"flow_rate_sensor",battery_level:"battery_level",last_report:"last_report",watering_duration:"duration",rain_snow_delay:"rain_snow_delay",battery:"battery_level",indexed_irrigation_duration:"duration"},vt=[[/_last_watering_start$/,"start_time_sensor"],[/_last_watering_end$/,"end_time_sensor"],[/_watering_flow_rate$/,"flow_rate_sensor"],[/_watering_value$/,"value_sensor"],[/_watering_volume$/,"volume_sensor"],[/_watering_duration$/,"duration"],[/_watering_mode$/,"mode_sensor"],[/_rain_snow_delay$/,"rain_snow_delay"],[/_battery_level$/,"battery_level"]];function gt(t,e,i,s,n,a={}){const r=t.devices[i],o=n.attributes.valve_name??n.attributes.valve_factory_name??r?.name_by_user??r?.name??s,l=n.attributes.valve_factory_name??r?.name??o,d=`${_t}?id=${encodeURIComponent(s)}`;const c={device_id:s,registry_entity:e,valve_name:o,factory_name:l,valve_home:a[s]?.home??a[i]?.home??n.attributes.valve_home??null,valve_room:a[s]?.room??a[i]?.room??n.attributes.valve_room??null,view_path:d},p=(t,e)=>{c[t]||(c[t]=e)};let h;for(const e of Object.values(t.entities)){if(e.device_id!==i)continue;if(!t.states[e.entity_id])continue;if(e.entity_id.startsWith("switch.")&&("valve"===e.translation_key||"indexed_switch"===e.translation_key||e.entity_id.endsWith("_valve"))){c.switch||(c.switch=e.entity_id);continue}if(e.entity_id.startsWith("switch.")&&"switch_1"===e.translation_key){h||(h=e.entity_id);continue}if(e.entity_id.startsWith("switch.")&&e.entity_id.endsWith("_sleep_mode")){c.sleep_mode=e.entity_id;continue}const s=e.translation_key;if(s){const t=ft[s];if(t){p(t,e.entity_id);continue}}for(const[t,i]of vt)if(t.test(e.entity_id)){p(i,e.entity_id);break}}return!c.switch&&h&&(c.switch=h),c}const _t="valve";const $t={runs:[],planned:[],sites:[],locations:[],locationOf:{},pumps:[],pumpAssignments:[]};let bt=null;function xt(t,e=Date.now()){if(!bt||e-bt.at>6e4){const i=async function(t,e){if(!t.callApi)return $t;const i=t=>encodeURIComponent(new Date(t).toISOString()),[s,n,a]=await Promise.all([t.callApi("GET",`xtend_tuya/runs?since=${i(e-2592e6)}`),t.callApi("GET","xtend_tuya/irrigation_locations"),t.callApi("GET",`calendars/calendar.irrigation_planned?start=${i(e-1728e5)}&end=${i(e+6912e5)}`)]),r=t=>t?Date.parse(t):null,o=new Map((n?.sites??[]).map(t=>[t.id,t.name])),l=[],d={};for(const t of n?.locations??[]){const e=t.devices??[],i=t.pump?{name:t.pump.name,via:t.pump.inherited_from?o.get(t.pump.inherited_from)??null:null}:null,s={id:t.id,name:t.name,site_id:t.site_id??null,valves:e.filter(t=>null===t.end).map(t=>t.device_id),assignments:e.map(t=>({device_id:t.device_id,begin:r(t.begin),end:r(t.end)})),expected_lpm:t.expected_lpm??null,pump:i};l.push(s);for(const t of s.valves)d[t]=s}const c=[];for(const t of a??[]){const e=Date.parse(t.start.dateTime??t.start.date??""),i=Date.parse(t.end.dateTime??t.end.date??"");Number.isFinite(e)&&c.push({key:(t.uid??"").split("#")[0],start:e,end:i>e?i:e+6e4})}return{runs:s?.runs??[],planned:c,sites:n?.sites??[],locations:l,locationOf:d,pumps:n?.pumps??[],pumpAssignments:n?.pump_assignments??[]}}(t,e);bt={at:e,data:i},i.catch(()=>{bt?.data===i&&(bt=null)})}return bt.data}const yt=864e5,wt=864e5,kt=/\((\d+)\)\s*$/;function At(t){if(!t)return null;const e=Number(t.state);return Number.isFinite(e)&&""!==t.state?e:null}function St(t){return!t||"unavailable"===t.state||"unknown"===t.state}function Et(t){const e=new Date(t);return e.setHours(0,0,0,0),e.getTime()}function Ct(t,e,i){const s=Et(e)-5184e5,n={runs:0,liters:0,minutes:0,daily:[0,0,0,0,0,0,0],unit:i?"L":"min"};for(const e of t){if(e.start<s)continue;const t=Math.min(6,Math.round((Et(e.start)-s)/wt));n.runs+=1,n.liters+=e.liters??0,n.minutes+=e.minutes,n.daily[t]+=i?e.liters??0:e.minutes}return n}function Mt(t,e,i,s){const n=e[t.registry_entity],a=t.switch?e[t.switch]:void 0,r=St(n)&&St(a),o=!r&&"on"===a?.state,l=i.runs.filter(e=>e.device_id===t.device_id).map(t=>({r:t,start:Date.parse(t.start),end:Date.parse(t.end)})).filter(t=>Number.isFinite(t.start)&&Number.isFinite(t.end)).sort((t,e)=>t.start-e.start),d=(t,e)=>({start:e,minutes:(t.duration_seconds??0)/60,liters:"number"==typeof t.liters?t.liters:null}),c=l[l.length-1],p=i.planned.filter(e=>e.key===t.registry_entity).sort((t,e)=>t.start-e.start),h=p.find(t=>t.start>s),u=p.filter(t=>t.end>s-yt&&t.end<s).map(e=>({start:e.start,end:e.end,kind:"planned",name:t.valve_name,key:t.device_id})),m=l.filter(t=>t.end>s-yt-wt).map(e=>({start:e.start,end:e.end,kind:"ran",name:t.valve_name,key:t.device_id})),f=function(t,e,i,s=9e5){const n=new Set,a=[];for(const r of[...t].sort((t,e)=>t.start-e.start)){let t=null;for(const i of e){if(n.has(i)||i.key!==r.key)continue;const e=Math.abs(i.start-r.start);e<=s&&(!t||e<Math.abs(t.start-r.start))&&(t=i)}t?(n.add(t),a.push({...t,kind:"running"===t.kind?"running":"ran",planStart:r.start,planEnd:r.end,summary:`${t.summary??""}\nplanned ${r.summary??""}`})):r.end+s<i?a.push({...r,kind:"missed"}):a.push(r)}for(const t of e)n.has(t)||a.push("running"===t.kind?t:{...t,kind:"unplanned"});return a}(u,m,s).filter(t=>"missed"===t.kind).length,v=!!t.volume_sensor,g=r?null:At(t.battery_level?e[t.battery_level]:void 0),_=t.last_report?Date.parse(e[t.last_report]?.state??""):NaN,$=c?d(c.r,c.start):null,b=[];r||(null!==g&&g<20&&b.push("low_battery"),Number.isFinite(_)&&s-_>1296e5&&b.push("stale"),f>0&&b.push("missed"),v&&$&&0===$.liters&&$.minutes>=1&&b.push("no_flow"));const x=i.locationOf[t.device_id]??null,y=x?.site_id?i.sites.find(t=>t.id===x.site_id)??null:null,w=t=>t?.last_changed?Date.parse(t.last_changed):null;return{device_id:t.device_id,name:t.valve_name,number:kt.exec(t.valve_name)?.[1]??null,view_path:t.view_path,status:r?"offline":o?"watering":"idle",since:o?w(a):r?w(n):null,flow_lpm:o?At(t.flow_rate_sensor?e[t.flow_rate_sensor]:void 0):null,battery:g,has_flow_meter:v,last:$,next:h?{start:h.start,minutes:(h.end-h.start)/6e4,liters:null}:null,week:Ct(l.map(t=>d(t.r,t.start)),s,v),missed:f,badges:b,location:x?{id:x.id,name:x.name}:null,site:y?{id:y.id,name:y.name}:null}}class Nt{constructor(t){this.valves=[],this.data=$t,this.loaded=!1,this.error=null,this.busy=!1,this.host=t,t.addController(this)}hostConnected(){this.timer=window.setInterval(()=>{this.refresh()},6e4)}hostDisconnected(){this.timer&&window.clearInterval(this.timer)}hostUpdated(){this.loaded||this.busy||!this.host.hass||this.refresh()}async refresh(t=!1){const e=this.host.hass;if(e&&!this.busy){t&&(bt=null),this.busy=!0;try{const[t,i]=await Promise.all([xt(e),ut(e)]);this.valves=function(t,e={}){const i=new Set;for(const e of Object.values(t.entities))e.translation_key===mt&&i.add(e.entity_id);for(const e of Object.keys(t.states))e.startsWith("sensor.")&&(e.endsWith(mt)||e.endsWith("_time_task_registry"))&&i.add(e);const s=[];for(const n of i){const i=t.states[n],a=t.entities[n];if(!i||!a||!a.device_id)continue;const r=i.attributes.device_id??a.device_id,o=gt(t,n,a.device_id,r,i,e);o&&s.push(o)}return s.sort((t,e)=>t.valve_name.localeCompare(e.valve_name)),s}(e,i),this.data=t,this.error=null}catch(t){this.error=t instanceof Error?t.message:String(t)}finally{this.busy=!1,this.loaded=!0,this.host.requestUpdate()}}}summaries(){const t=this.host.hass;if(!t)return[];const e=Date.now();return this.valves.map(i=>Mt(i,t.states,this.data,e))}}const Lt={site:null,status:"all",search:""},Pt={watering:"Watering now",attention:"Needs attention",sites:"Valves",offline:"Offline",unassigned:"Without location"},Ot=["watering","attention","sites","offline","unassigned"];function Tt(t,e){const i=new Set([e]);for(let e=!0;e;){e=!1;for(const s of t)s.parent_id&&i.has(s.parent_id)&&!i.has(s.id)&&(i.add(s.id),e=!0)}return i}function Ut(t,e){const i=new Map(t.map(t=>[t.id,t])),s=[];for(let t=i.get(e);t&&s.length<20;t=t.parent_id?i.get(t.parent_id):void 0)s.unshift(t.name);return s.join(" › ")}function zt(t){return"offline"!==t.status&&t.badges.length>0}function Dt(t,e,i){const s=e.site?Tt(i,e.site):null,n=e.search.trim().toLowerCase();return t.filter(t=>(!s||null!==t.site&&s.has(t.site.id))&&("all"===e.status||"watering"===e.status&&"watering"===t.status||"offline"===e.status&&"offline"===t.status||"attention"===e.status&&zt(t))&&(!n||t.name.toLowerCase().includes(n)||(t.location?.name.toLowerCase().includes(n)??!1)||(t.site?.name.toLowerCase().includes(n)??!1)))}function Ht(t){const e=window.location.pathname.split("/")[1]||"lovelace";window.history.pushState(null,"",t.startsWith("/")?t:`/${e}/${t}`),window.dispatchEvent(new Event("location-changed"))}const Rt=r`
  :host {
...
`,jt=[["all","All"],["watering","Watering"],["attention","Attention"],["offline","Offline"]];class Wt extends ot{constructor(){super(...arguments),this.sites=[],this.value=Lt,this.counts={}}_set(t){this.value={...this.value,...t},this.dispatchEvent(new CustomEvent("xt-filter-changed",{detail:this.value,bubbles:!0,composed:!0}))}render(){const t=[...this.sites].map(t=>({id:t.id,path:Ut(this.sites,t.id)})).sort((t,e)=>t.path.localeCompare(e.path));return B`
  ...
  `],t([pt({attribute:!1})],oe.prototype,"sites",void 0),t([pt({attribute:!1})],oe.prototype,"selected",void 0),t([pt({attribute:!1})],oe.prototype,"counts",void 0),t([pt({type:Boolean})],oe.prototype,"noSite",void 0),t([ht()],oe.prototype,"_closed",void 0),customElements.get("xt-site-tree")||customElements.define("xt-site-tree",oe);const le={no_valve:["No valve","No valve is assigned to this metering point","warn"],low_battery:["Low battery","The valve's battery is below 20 %","warn"],stale:["No report 36 h","The valve has not reported for more than 36 hours","warn"],missed:["Missed","A planned run in the last 24 hours did not happen","bad"],no_flow:["No water flow","The last run here measured no water","bad"],flow_low:["Flow low","Mean flow of the last 30 days is well below the expected L/min","bad"],flow_high:["Flow high","Mean flow of the last 30 days is well above the expected L/min (leak?)","bad"]},de={watering:"Watering",idle:"Idle",offline:"Offline"};function ce(t){const e=[Vt(t.start),`${Math.round(t.minutes)} min`];return null!==t.liters&&e.push(`${Math.round(t.liters)} L`),e.join(" · ")}class pe extends ot{_openValve(t,e){t.stopPropagation(),this.dispatchEvent(new CustomEvent("xt-valve-open",{detail:e.view_path,bubbles:!0,composed:!0}))}_valve(t){return B`<button class="valve ${t.status}" @click=${e=>this._openValve(e,t)} title="Open valve ${t.name}">
      ...
      <div class="name" title="Metering point">${t.name}</div>
  ...
  `],t([pt({attribute:!1})],pe.prototype,"summary",void 0),customElements.get("xt-mp-card")||customElements.define("xt-mp-card",pe);function he(){return new URLSearchParams(window.location.search).get("site")}class ue extends ot{constructor(){super(...arguments),this._selected=he(),this._edit=!1,this._busy=!1,this._error=null,this._farm=new Nt(this),this._onLocation=()=>{this._selected=he()}}setConfig(t){}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),window.addEventListener("location-changed",this._onLocation),window.addEventListener("popstate",this._onLocation)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("location-changed",this._onLocation),window.removeEventListener("popstate",this._onLocation)}_open(t){const e=new URL(window.location.href);t?e.searchParams.set("site",t):e.searchParams.delete("site"),window.history.pushState(null,"",e.pathname+e.search),this._selected=t,this._error=null}async _post(t){if(!this.hass?.callApi)return!1;this._busy=!0,this._error=null;try{return await this.hass.callApi("POST","xtend_tuya/irrigation_locations",t),await this._farm.refresh(!0),!0}catch(t){const e=t;return this._error=e.body?.error??e.message??String(t),!1}finally{this._busy=!1}}async _createSite(t,e){const i=t.querySelector("input");i.value.trim()&&await this._post({action:"create_site",name:i.value,parent_id:e})&&(i.value="")}async _saveSite(t,e){const i=t.querySelector("input").value,s=t.querySelector("select").value||null;await this._post({action:"update_site",id:e.id,name:i,parent_id:s})}async _deleteSite(t){await this._post({action:"delete_site",id:t.id})&&this._open(t.parent_id)}_header(t,e){const i=[{id:null,name:"All sites"}];if(t&&t.id!==ie){const e=new Map(this._farm.data.sites.map(t=>[t.id,t])),s=[];for(let i=e.get(t.id);i&&s.length<20;i=i.parent_id?e.get(i.parent_id):void 0)s.unshift(i);i.push(...s.map(t=>({id:t.id,name:t.name})))}else t&&i.push({id:ie,name:"No site"});const s=i[i.length-1].name;return B`<div class="header">
    ...
    </form>`}_mpCard(t,e){const i=B`<xt-mp-card .summary=${e}></xt-mp-card>`;if(!this._edit)return i;const s=this._farm.data.sites.map(t=>({id:t.id,path:Ut(this._farm.data.sites,t.id)})).sort((t,e)=>t.path.localeCompare(e.path));return B`<div class="mp-edit">
      ${i}
      <select
      ...
      <main>
        ...
        ${p.length?B`<h3>Metering points <span class="count">${p.length}</span></h3>
              <div class="grid">${p.map(t=>this._mpCard(t,n.get(t.id)))}</div>`:q}
  ...
  `],t([pt({attribute:!1})],ue.prototype,"hass",void 0),t([ht()],ue.prototype,"_selected",void 0),t([ht()],ue.prototype,"_edit",void 0),t([ht()],ue.prototype,"_busy",void 0),t([ht()],ue.prototype,"_error",void 0),customElements.get("irrigation-sites-card")||customElements.define("irrigation-sites-card",ue);
