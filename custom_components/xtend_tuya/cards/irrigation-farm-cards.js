...
`,Yt=[["all","All"],["watering","Watering"],["attention","Attention"],["offline","Offline"]];class Xt extends dt{constructor(){super(...arguments),this.sites=[],this.value=Ft,this.counts={},this.statuses=!0}_set(t){this.value={...this.value,...t},this.dispatchEvent(new CustomEvent("xt-filter-changed",{detail:this.value,bubbles:!0,composed:!0}))}render(){const t=[...this.sites].map(t=>({id:t.id,path:qt(this.sites,t.id)})).sort((t,e)=>t.path.localeCompare(e.path));return B`
      <select
        aria-label="Site"
  ...
  `],t([ht({attribute:!1})],Xt.prototype,"sites",void 0),t([ht({attribute:!1})],Xt.prototype,"value",void 0),t([ht({attribute:!1})],Xt.prototype,"counts",void 0),t([ht({type:Boolean})],Xt.prototype,"statuses",void 0),customElements.get("xt-valve-filter-bar")||customElements.define("xt-valve-filter-bar",Xt);const Zt=864e5;function Qt(t,e=Date.now()){const i=new Date(t),s=new Date(e);s.setHours(0,0,0,0);const n=Math.floor((i.getTime()-s.getTime())/Zt);return 0===n?"Today":-1===n?"Yesterday":1===n?"Tomorrow":i.toLocaleDateString(void 0,{weekday:"short",day:"numeric",month:"short"})}function te(t){return new Date(t).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}function ee(t){return`${Qt(t)} ${te(t)}`}function ie(t,e=Date.now()){const i=Math.round((e-t)/6e4);if(i<60)return`${i} min`;const s=Math.round(i/60);return s<48?`${s} h`:`${Math.round(s/24)} d`}function se(t){return`${Math.round(t).toLocaleString()} L`}function ne(t){return t>=95?"mdi:battery":t<10?"mdi:battery-outline":"mdi:battery-"+10*Math.floor(t/10)}function ae(t){return Math.abs(t)<1e3?`${Math.round(t)} L`:`${(t/1e3).toFixed(1)} m³`}class re extends dt{constructor(){super(...arguments),this.daily=[],this.unit="L"}render(){const t=Math.max(...this.daily,0),e=new Date;e.setHours(12,0,0,0);const i=this.daily.length;return this.daily.map((s,n)=>B`<span
          title="${(t=>new Date(e.getTime()-(i-1-t)*Zt).toLocaleDateString(void 0,{weekday:"short",day:"numeric",month:"short"}))(n)}: ${Math.round(s).toLocaleString()} ${this.unit}"
  ...
  `],t([ht({attribute:!1})],re.prototype,"daily",void 0),t([ht()],re.prototype,"unit",void 0),customElements.get("xt-week-bars")||customElements.define("xt-week-bars",re);const oe={low_battery:"Low battery",stale:"No report 36 h",missed:"Missed",no_flow:"No water flow"},le={low_battery:"Battery below 20 %",stale:"The valve has not reported for more than 36 hours",missed:"A planned run in the last 24 hours did not happen",no_flow:"The last run measured no water"};function de(t){const e=[ee(t.start),`${Math.round(t.minutes)} min`];return null!==t.liters&&e.push(`${Math.round(t.liters)} L`),e.join(" · ")}function ce(t){return(t.number?t.name.replace(/\s*\(\d+\)\s*$/,""):t.name)||t.name}class pe extends dt{_open(){this.summary&&this.dispatchEvent(new CustomEvent("xt-valve-open",{detail:this.summary.view_path,bubbles:!0,composed:!0}))}_status(t){if("watering"===t.status){const e=null!==t.flow_lpm?` · ${t.flow_lpm.toFixed(1)} L/min`:"";return B`<span class="status watering" title="Watering now"><i></i>Watering${t.since?` since ${te(t.since)}`:""}${e}</span>`}return"offline"===t.status?B`<span class="status offline" title="Not reachable"><i></i>Offline${t.since?` for ${ie(t.since)}`:""}</span>`:B`<span class="status idle" title="Online, not watering"><i></i>Idle</span>`}_week(t){const e=t.week.unit,i="L"===e?`${Math.round(t.week.liters)} L`:`${Math.round(t.week.minutes)} min`;return B`<div class="week">
      ...
      >
    </div>`}render(){const t=this.summary;if(!t)return G;const e=t.location&&t.location.name!==ce(t)?t.location.name:null,i=t.location?[e,t.site?.name].filter(Boolean).join(" · "):"No location";return B`<ha-card class=${t.status} @click=${this._open} tabindex="0" role="link" aria-label=${t.name}>
      <div class="head">
        <span class="name" title=${t.name}>${ce(t)}</span>
        ...
        ${null!==t.battery?B`<span class="battery ${t.badges.includes("low_battery")?"low":""}" title="Battery ${Math.round(t.battery)} %"
              ><ha-icon icon=${ne(t.battery)}></ha-icon>${Math.round(t.battery)} %</span
            >`:G}
      </div>
      ...
      <dl>
        ...
        <dd title="Last run: start · duration${t.has_flow_meter?" · water":""}">${t.last?de(t.last):"–"}</dd>
      ...
      ${t.badges.length?B`<div class="badges">
            ${t.badges.map(e=>B`<span class="badge ${e}" title=${le[e]}>${oe[e]}${"missed"===e&&t.missed>1?` ${t.missed}`:""}</span>`)}
          </div>`:G}
    </ha-card>`}}pe.styles=[Jt,r`
    :host {
      display: block;
    }
    ha-card {
  ...
  `],t([ht({attribute:!1})],pe.prototype,"summary",void 0),customElements.get("xt-valve-card")||customElements.define("xt-valve-card",pe);class ue extends dt{constructor(){super(...arguments),this.collapsed=!1}render(){const t=this.section;return t?B`
  ...
  `],t([ht({attribute:!1})],ue.prototype,"section",void 0),t([ht({type:Boolean,reflect:!0})],ue.prototype,"collapsed",void 0),customElements.get("xt-valve-section")||customElements.define("xt-valve-section",ue);const he="xt-valves-filter";class me extends dt{constructor(){super(...arguments),this._filter=function(){try{return{...Ft,...JSON.parse(localStorage.getItem(he)??"{}")}}catch{return Ft}}(),this._farm=new Ht(this)}setConfig(t){this._config=t}getCardSize(){return 12}_onFilter(t){this._filter=t.detail,function(t){try{localStorage.setItem(he,JSON.stringify(t))}catch{}}(t.detail)}_onOpen(t){Kt(t.detail)}render(){if(!this._config||!this.hass)return G;if(!this._farm.loaded)return B`<ha-card><div class="msg">Loading valves…</div></ha-card>`;const t=this._farm.summaries(),e=this._farm.data,i=this._config.site??null,s={...this._filter,site:i??this._filter.site},n=Gt(t,{...s,status:"all"},e.sites),a={};for(const t of["all","watering","attention","offline"])a[t]="all"===t?n.length:Gt(n,{...Ft,status:t},e.sites).length;const r=function(t,e,i=Wt){const s=(t,e)=>t.name.localeCompare(e.name),n=(t,e)=>({key:t,title:jt[t],groups:[{site:null,title:"",valves:[...e].sort(s)}],count:e.length}),a=t.filter(t=>"offline"!==t.status),r=a.filter(t=>t.location),o=new Map;for(const t of r){const e=t.site?.id??null;o.set(e,[...o.get(e)??[],t])}const l=[...o.entries()].map(([t,i])=>({site:t,title:t?qt(e,t):"No site",valves:i.sort(s)})).sort((t,e)=>null===t.site?1:null===e.site?-1:t.title.localeCompare(e.title)),d={watering:n("watering",a.filter(t=>"watering"===t.status)),attention:n("attention",a.filter(Vt)),sites:{key:"sites",title:jt.sites,groups:l,count:r.length},offline:n("offline",t.filter(t=>"offline"===t.status)),unassigned:n("unassigned",a.filter(t=>!t.location))};return i.map(t=>d[t]).filter(t=>t.count>0)}(Gt(n,{...Ft,status:s.status},e.sites),e.sites,this._config.sections??Wt),o=new Set(this._config.collapsed??["offline"]);return B`
  ...
  `],t([ht({attribute:!1})],xe.prototype,"summary",void 0),customElements.get("xt-site-card")||customElements.define("xt-site-card",xe);class _e extends dt{constructor(){super(...arguments),this.sites=[],this.selected=null,this.counts={},this.noSite=!1,this._closed=new Set}_open(t){this.dispatchEvent(new CustomEvent("xt-site-open",{detail:t,bubbles:!0,composed:!0}))}_toggle(t,e){t.stopPropagation();const i=new Set(this._closed);i.has(e)?i.delete(e):i.add(e),this._closed=i}_node(t,e){const i=ge(this.sites,t.id),s=this._closed.has(t.id);return B`
      <button
    ...
    `}render(){return B`
      ...
      ${ge(this.sites,null).map(t=>this._node(t,0))}
      ${this.noSite?B`<button class="node ${this.selected===ve?"on":""}" @click=${()=>this._open(ve)}>
            <span class="chev"></span><span class="label dim">No site</span>
            <span class="count">${this.counts[ve]??""}</span>
          </button>`:G}
    `}}_e.styles=[Jt,r`
    :host {
      display: flex;
  ...
  `],t([ht({attribute:!1})],_e.prototype,"sites",void 0),t([ht({attribute:!1})],_e.prototype,"selected",void 0),t([ht({attribute:!1})],_e.prototype,"counts",void 0),t([ht({type:Boolean})],_e.prototype,"noSite",void 0),t([mt()],_e.prototype,"_closed",void 0),customElements.get("xt-site-tree")||customElements.define("xt-site-tree",_e);const ye={no_valve:["No valve","No valve is assigned to this metering point","warn"],low_battery:["Low battery","The valve's battery is below 20 %","warn"],stale:["No report 36 h","The valve has not reported for more than 36 hours","warn"],missed:["Missed","A planned run in the last 24 hours did not happen","bad"],no_flow:["No water flow","The last run here measured no water","bad"],flow_low:["Flow low","Mean flow of the last 30 days is well below the expected L/min","bad"],flow_high:["Flow high","Mean flow of the last 30 days is well above the expected L/min (leak?)","bad"]},$e={watering:"Watering",idle:"Idle",offline:"Offline"};function we(t){const e=[ee(t.start),`${Math.round(t.minutes)} min`];return null!==t.liters&&e.push(`${Math.round(t.liters)} L`),e.join(" · ")}class ke extends dt{constructor(){super(...arguments),this.editable=!1}_openValve(t,e){t.stopPropagation(),this.dispatchEvent(new CustomEvent("xt-valve-open",{detail:e.view_path,bubbles:!0,composed:!0}))}_valve(t){return B`<button class="valve ${t.status}" @click=${e=>this._openValve(e,t)} title="Open valve ${t.name}">
      <ha-icon icon="mdi:valve"></ha-icon>
      <span class="num">${t.number?`#${t.number}`:t.name}</span>
      <i></i><span>${$e[t.status]}</span>
      ...
      <dl>
        ...
        <dd title="Last run here: start · duration · water">${t.last?we(t.last):"–"}</dd>
        <dt title="Next planned run"><ha-icon icon="mdi:calendar-clock"></ha-icon></dt>
      ...
      ${this._flow(t)}
      ${t.badges.length?B`<div class="badges">
            ${t.badges.map(e=>{const[i,s,n]=ye[e];return B`<span class="badge ${n}" title=${s}>${i}${"missed"===e&&t.missed>1?` ${t.missed}`:""}</span>`})}
          </div>`:G}
    </ha-card>`}}ke.styles=[Jt,r`
    :host {
      display: block;
    }
    ha-card {
  ...
  `],t([ht({attribute:!1})],ke.prototype,"summary",void 0),t([ht({type:Boolean})],ke.prototype,"editable",void 0),customElements.get("xt-mp-card")||customElements.define("xt-mp-card",ke);const Se={watering:"Watering",idle:"Idle",offline:"Offline"};function Ee(t){return new Date(t).toLocaleDateString(void 0,{day:"numeric",month:"short",year:"numeric"})}class Ae extends dt{constructor(){super(...arguments),this.sites=[],this.valves=[],this.busy=!1,this.error=null}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_save(t){t.preventDefault();const e=t.target,i=t=>e.elements.namedItem(t).value,s=i("expected_lpm").trim();this._fire("xt-mp-save",{name:i("name"),description:i("description"),expected_lpm:""===s?null:Number(s),site_id:i("site_id")||null})}_valveLine(t,e){return B`<div class="valve">
      <ha-icon icon="mdi:valve"></ha-icon>
      <span class="num">${t?.label??e}</span>
      ${t?B`<i class=${t.status}></i><span>${Se[t.status]}</span>`:G}
      ${null!=t?.battery?B`<span class="dim"><ha-icon icon=${ne(t.battery)}></ha-icon>${Math.round(t.battery)} %</span>`:G}
        ...
        ${s.length?B`<section>
              ...
              <ul>
                ${s.map(t=>B`<li>
                    ...
                    <span class="dim"
                      >${t.begin?Ee(t.begin):"from the start"} – ${t.end?Ee(t.end):"now"}</span
                    >
                  </li>`)}
              </ul>
            </section>`:G}
    ...
    `],t([ht({attribute:!1})],Ae.prototype,"mp",void 0),t([ht({attribute:!1})],Ae.prototype,"sites",void 0),t([ht({attribute:!1})],Ae.prototype,"valves",void 0),t([ht({type:Boolean})],Ae.prototype,"busy",void 0),t([ht()],Ae.prototype,"error",void 0),customElements.get("xt-mp-editor")||customElements.define("xt-mp-editor",Ae);const Me=r`
    :host {
      display: block;
    }
    .layout {
...
`,Ce="xtend_tuya/irrigation_locations";function Le(){return new URLSearchParams(window.location.search).get("site")}class Ne extends dt{constructor(){super(...arguments),this._selected=Le(),this._edit=!1,this._editing=null,this._busy=!1,this._error=null,this._farm=new Ht(this),this._mpMemo=null,this._onLocation=()=>{this._selected=Le()}}setConfig(t){}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),window.addEventListener("location-changed",this._onLocation),window.addEventListener("popstate",this._onLocation)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("location-changed",this._onLocation),window.removeEventListener("popstate",this._onLocation)}_open(t){const e=new URL(window.location.href);t?e.searchParams.set("site",t):e.searchParams.delete("site"),window.history.pushState(null,"",e.pathname+e.search),this._selected=t,this._error=null}async _post(t){if(!this.hass?.callApi)return!1;this._busy=!0,this._error=null;try{return await this.hass.callApi("POST",Ce,t),await this._farm.refresh(!0),!0}catch(t){const e=t;return this._error=e.body?.error??e.message??String(t),!1}finally{this._busy=!1}}async _createSite(t,e){const i=t.querySelector("input");i.value.trim()&&await this._post({action:"create_site",name:i.value,parent_id:e})&&(i.value="")}async _saveSite(t,e){const i=t.querySelector("input").value,s=t.querySelector("select").value||null;await this._post({action:"update_site",id:e.id,name:i,parent_id:s})}async _deleteSite(t){await this._post({action:"delete_site",id:t.id})&&this._open(t.parent_id)}_header(t,e){const i=[{id:null,name:"All sites"}];if(t&&t.id!==ve){const e=new Map(this._farm.data.sites.map(t=>[t.id,t])),s=[];for(let i=e.get(t.id);i&&s.length<20;i=i.parent_id?e.get(i.parent_id):void 0)s.unshift(i);i.push(...s.map(t=>({id:t.id,name:t.name})))}else t&&i.push({id:ve,name:"No site"});const s=i[i.length-1].name;return B`<div class="header">
      ...
      <div class="figures">
        ${t?B`
              ...
              <span title="Last 7 days"
                ><xt-week-bars .daily=${t.week.daily}></xt-week-bars>${t.week.runs} runs · ${se(t.week.liters)}</span
              >
    ...
    ></xt-mp-editor>`}_addMp(t){return B`<form class="editor" @submit=${e=>(e.preventDefault(),this._createMp(e.target,t))}>
      ...
      <button type="submit" ?disabled=${this._busy}>Add</button>
    </form>`}render(){if(!this.hass)return G;if(!this._farm.loaded)return B`<ha-card><div class="msg">Loading sites…</div></ha-card>`;const t=this._farm.data,e=this._farm.summaries();if(this._mpMemo?.valves!==e){const i=Date.now();this._mpMemo={valves:e,list:t.locations.map(s=>be(s,t,e,i))}}const i=this._mpMemo.list,s=new Map(i.map(t=>[t.id,t])),n=t.locations.some(t=>!t.site_id),a=this._selected&&(this._selected===ve||t.sites.some(t=>t.id===this._selected))?this._selected:null,r=a&&a!==ve?t.sites.find(t=>t.id===a)??null:null,o=a?fe(a,t,i):null,l=a?o.children:[...ge(t.sites,null).map(t=>t.id),...n?[ve]:[]],d=l.map(e=>fe(e,t,i)),c=a?t.locations.filter(t=>a===ve?!t.site_id:t.site_id===a).sort((t,e)=>t.name.localeCompare(e.name)):[],p={};for(const e of t.sites)p[e.id]=t.locations.filter(i=>Bt(t.sites,e.id).has(i.site_id??"")).length;p[ve]=t.locations.filter(t=>!t.site_id).length;const u=i.flatMap(t=>t.valves),h={sites:t.sites.length,mps:t.locations.length,valves:u.length,online:u.filter(t=>"offline"!==t.status).length},m=this._editing?t.locations.find(t=>t.id===this._editing):void 0;return B`<div
      class="layout"
      @xt-site-open=${t=>this._open(t.detail)}
      @xt-valve-open=${t=>Kt(t.detail)}
    ...
    >
      ...
      <main>
        ...
        ${d.length||this._edit&&a!==ve?B`<h3>${a?"Sub-sites":"Sites"} <span class="count">${d.length}</span></h3>
              <div class="grid">${d.map(t=>B`<xt-site-card .summary=${t}></xt-site-card>`)}</div>
              ${this._edit&&a!==ve?this._addSite(a):G}`:G}
        ${c.length||this._edit&&a?B`<h3>Metering points <span class="count">${c.length}</span></h3>
              ...
              ${this._edit&&a?this._addMp(a===ve?null:a):G}`:G}
    ...
    </div>`}}Ne.styles=[Jt,Me],t([ht({attribute:!1})],Ne.prototype,"hass",void 0),t([mt()],Ne.prototype,"_selected",void 0),t([mt()],Ne.prototype,"_edit",void 0),t([mt()],Ne.prototype,"_editing",void 0),t([mt()],Ne.prototype,"_busy",void 0),t([mt()],Ne.prototype,"_error",void 0),customElements.get("irrigation-sites-card")||customElements.define("irrigation-sites-card",Ne);const ze=1e3;function Oe(t,e){return(null===t.begin||t.begin<=e)&&(null===t.end||e<t.end)}function De(t,e,i){const s=(e,s)=>t.pumpAssignments.find(t=>t.target_kind===e&&t.target_id===s&&Oe(t,i))?.pump_id??null,n=s("location",e.id);if(n)return n;const a=new Map(t.sites.map(t=>[t.id,t]));for(let t=e.site_id?a.get(e.site_id):void 0,i=0;t&&i<20;i++){const e=s("site",t.id);if(e)return e;t=t.parent_id?a.get(t.parent_id):void 0}return null}function Pe(t,e,i){const s=t.pumpAssignments.filter(t=>t.pump_id===e&&"site"===t.target_kind&&Oe(t,i)).map(t=>t.target_id),n=[],a=[],r=e=>{const i=new Map(t.sites.map(t=>[t.id,t]));for(let t=e.site_id?i.get(e.site_id):void 0,n=0;t&&n<20;n++){if(s.includes(t.id))return!0;t=t.parent_id?i.get(t.parent_id):void 0}return!1};for(const s of t.locations){const o=De(t,s,i);o===e?n.push(s.id):o&&r(s)&&a.push({mp:s.id,pump:o})}return{sites:s,mps:n,overridden:a}}function Te(t,e){const i=new Date(t);return i.setMinutes(0,0,0),"day"===e&&i.setHours(0),i.getTime()}function Re(t,e,i,s,n,a){const r=new Map,o=t=>{const e=Te(t,a);let i=r.get(e);return i||r.set(e,i={start:e,pump:null,valves:0,consumers:0}),i},l="hour"===a?36e5:864e5;for(let t=Te(s,a);t<n;t+=l)o(t);let d=null;for(const t of i[e.meter_entity]??[]){if(t.start<s||t.start>=n||"number"!=typeof t.change)continue;const e=o(t.start);e.pump=(e.pump??0)+t.change*ze,d=(d??0)+t.change*ze}let c=0;for(const i of t.runs){const a=Date.parse(i.end);if(a<s||a>=n||"number"!=typeof i.liters)continue;const r=At(t,i.device_id,a);r&&De(t,r,a)===e.id&&(c+=i.liters,o(Date.parse(i.start)).valves+=i.liters)}let p=0;for(const a of function(t,e,i,s){return t.pumpConnections.filter(t=>t.pump_id===e&&(null===t.begin||t.begin<s)&&(null===t.end||t.end>i))}(t,e.id,s,n))if("consumer"===a.role&&a.meter_entity)for(const t of i[a.meter_entity]??[])t.start<s||t.start>=n||"number"!=typeof t.change||!Oe(a,t.start)||(p+=t.change*ze,o(t.start).consumers+=t.change*ze);return{pump:d,valves:c,consumers:p,unaccounted:null===d?null:d-c-p,buckets:[...r.values()].sort((t,e)=>t.start-e.start)}}const Ue="__no_pump__";class Ie extends dt{constructor(){super(...arguments),this.items=[],this.selected=null}render(){return this.items.map(t=>B`<button
        class="node ${t.id===this.selected?"on":""}"
        aria-current=${t.id===this.selected?"page":"false"}
        @click=${()=>this.dispatchEvent(new CustomEvent("xt-pump-open",{detail:t.id,bubbles:!0,composed:!0}))}
      >
        ${t.id===Ue?B`<span class="dot none"></span>`:B`<span class="dot ${t.state}" title=${"unknown"===t.state?"No data from the pump":t.state}></span>`}
        <span class="label ${t.id===Ue?"dim":""}">${t.name}</span>
        <span class="count">${t.count}</span>
      </button>`)}}Ie.styles=[Jt,r`
      :host {
        display: flex;
        flex-direction: column;
        gap: 1px;
    ...
    `],t([ht({attribute:!1})],Ie.prototype,"items",void 0),t([ht({attribute:!1})],Ie.prototype,"selected",void 0),customElements.get("xt-pump-list")||customElements.define("xt-pump-list",Ie);const He=160;class Fe extends dt{constructor(){super(...arguments),this.buckets=[],this.period="hour"}_label(t){const e=new Date(t);return"hour"===this.period?e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):e.toLocaleDateString(void 0,{weekday:"short",day:"numeric"})}render(){const t=this.buckets.length;if(!t)return G;const e=Math.max(1,...this.buckets.map(t=>Math.max(t.pump??0,t.valves+t.consumers))),i=100/t,s=t=>t/e*142,n=Math.ceil(t/8);return B`
      <svg viewBox="0 0 100 ${He}" preserveAspectRatio="none" role="img" aria-label="Pump delivery against valve and consumer use">
        ${this.buckets.map((t,e)=>{const n=e*i,a=t.valves+t.consumers,r=`${this._label(t.start)}: pump ${null===t.pump?"no data":ae(t.pump)}, valves ${ae(t.valves)}${t.consumers?`, consumers ${ae(t.consumers)}`:""}${null!==t.pump?`, unaccounted ${ae(t.pump-a)}`:""}`;return q`<g>
            <title>${r}</title>
    ...
    `],t([ht({attribute:!1})],Fe.prototype,"buckets",void 0),t([ht()],Fe.prototype,"period",void 0),customElements.get("xt-pump-chart")||customElements.define("xt-pump-chart",Fe);class je extends dt{constructor(){super(...arguments),this.devices=[],this.exclude=[],this.placeholder="Search devices by name, area or model",this._q=""}render(){const t=this._q.trim().toLowerCase(),e=t?this.devices.filter(t=>!this.exclude.includes(t.id)).filter(e=>[e.name,e.area,e.model].some(e=>e?.toLowerCase().includes(t))).slice(0,30):[];return B`
    ...
    `}_pick(t){this._q="",this.dispatchEvent(new CustomEvent("xt-device-picked",{detail:t,bubbles:!0,composed:!0}))}}je.styles=[Jt,r`
      :host {
        display: flex;
        flex-direction: column;
        gap: 4px;
    ...
    `],t([ht({attribute:!1})],je.prototype,"devices",void 0),t([ht({attribute:!1})],je.prototype,"exclude",void 0),t([ht()],je.prototype,"placeholder",void 0),t([mt()],je.prototype,"_q",void 0),customElements.get("xt-device-picker")||customElements.define("xt-device-picker",je);const We={"24h":{ms:864e5,period:"hour"},"7d":{ms:6048e5,period:"day"},"30d":{ms:2592e6,period:"day"}},Be="xt-pumps-range",qe=["meter_entity","flow_entity","pressure_entity","status_entity"],Ve={meter_entity:"Water meter (m³ total)",flow_entity:"Flow rate",pressure_entity:"Pressure",status_entity:"Status"},Ge={meter_entity:/_fct_total_delivered_flow_mc$/,flow_entity:/_vf_flowliter$/,pressure_entity:/_vp_pressurebar$/,status_entity:/_pumpstatus$/};function Ke(){return new URLSearchParams(window.location.search).get("pump")}class Je extends dt{constructor(){super(...arguments),this._selected=Ke(),this._range=function(){try{const t=localStorage.getItem(Be);return t&&t in We?t:"7d"}catch{return"7d"}}(),this._stats={},this._edit=!1,this._busy=!1,this._error=null,this._connecting=null,this._statsKey="",this._farm=new Ht(this),this._balanceMemo=null,this._mpMemo=null,this._onLocation=()=>{this._selected=Ke()}}setConfig(t){}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),window.addEventListener("location-changed",this._onLocation),window.addEventListener("popstate",this._onLocation)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("location-changed",this._onLocation),window.removeEventListener("popstate",this._onLocation)}updated(){const t=`${this._range}|${this._farm.data.pumps.length}|${this._farm.data.pumpConnections.length}`;this.hass?.callApi&&this._farm.loaded&&t!==this._statsKey&&(this._statsKey=t,this._loadStats())}async _loadStats(){const{ms:t}=We[this._range],e=new Date(Date.now()-t).toISOString();try{const t=await this.hass.callApi("GET",`xtend_tuya/pump_stats?period=hour&start=${encodeURIComponent(e)}`);this._stats=t.series??{}}catch(t){this._error=`Could not load pump statistics: ${t instanceof Error?t.message:String(t)}`}}_state(t){return t?this.hass?.states[t]:void 0}_num(t){const e=this._state(t),i=Number(e?.state);return e&&""!==e.state&&Number.isFinite(i)?i:null}_pumpState(t){const e=this._state(t.status_entity)?.state,i=this._num(t.flow_entity),s=this._state(t.meter_entity)?.state;return s&&"unknown"!==s&&"unavailable"!==s?"Go"===e||null!==i&&i>0?"running":"idle":"unknown"}_devices(){const t=this.hass?.areas??{};return Object.values(this.hass?.devices??{}).map(e=>({id:e.id,name:e.name_by_user||e.name||e.id,area:e.area_id?t[e.area_id]?.name??null:null,model:e.model??null}))}_deviceName(t){const e=this.hass?.devices[t];return e&&(e.name_by_user||e.name)||t}_sensorsOf(t){return t&&this.hass?Object.values(this.hass.entities).filter(e=>e.device_id===t&&e.entity_id.startsWith("sensor.")).map(t=>t.entity_id).sort():[]}_deviceOf(t){return t?this.hass?.entities[t]?.device_id??null:null}_open(t){const e=new URL(window.location.href);t?e.searchParams.set("pump",t):e.searchParams.delete("pump"),window.history.pushState(null,"",e.pathname+e.search),this._selected=t,this._error=null,this._connecting=null}_setRange(t){this._range=t;try{localStorage.setItem(Be,t)}catch{}}async _post(t){if(!this.hass?.callApi)return null;this._busy=!0,this._error=null;try{const e=await this.hass.callApi("POST","xtend_tuya/irrigation_locations",t);return await this._farm.refresh(!0),this._statsKey="",e}catch(t){const e=t;return this._error=e.body?.error??e.message??String(t),null}finally{this._busy=!1}}async _createPump(t){const e=this._sensorsOf(t),i=t=>e.find(e=>Ge[t].test(e))??null,s=i("meter_entity");if(!s)return void(this._error=`${this._deviceName(t)} has no water meter sensor (…_fct_total_delivered_flow_mc). Create the pump from its meter's device.`);const n=await this._post({action:"create_pump",name:this._deviceName(t),meter_entity:s,flow_entity:i("flow_entity"),pressure_entity:i("pressure_entity"),status_entity:i("status_entity")}),a=n?.pump;a&&this._open(a.id)}_savePump(t,e){t.preventDefault();const i=t.target,s=t=>i.elements.namedItem(t).value,n={action:"update_pump",id:e.id,name:s("name")};for(const t of qe)n[t]=s(t)||null;this._post(n)}_assign(t,e){t.preventDefault();const i=t.target.querySelector("select"),[s,n]=i.value.split(":");n&&this._post({action:"assign_pump",pump_id:e.id,target_kind:s,target_id:n})}_connect(t,e){t.preventDefault();const i=t.target,s=t=>i.elements.namedItem(t).value;this._post({action:"connect_device",pump_id:e.id,device_id:this._connecting,role:s("role"),meter_entity:s("meter_entity")||null}).then(t=>{t&&(this._connecting=null)})}_figures(t,e){const i=this._num(t.flow_entity),s=this._num(t.pressure_entity),n=this._state(t.status_entity)?.state,a=this._pumpState(t);return B`<div class="figures">
      ...
      >
    </div>`}_balance(t){const{ms:e,period:i}=We[this._range],s=`${t.id}|${this._range}|${Math.floor(Date.now()/6e4)}`,n=this._balanceMemo;if(!n||n.key!==s||n.data!==this._farm.data||n.stats!==this._stats){const n=Date.now();this._balanceMemo={key:s,data:this._farm.data,stats:this._stats,value:Re(this._farm.data,t,this._stats,n-e,n,i)}}const a=this._balanceMemo.value,r=t=>a.pump?` · ${Math.round(t/a.pump*100)} %`:"";return B`<section>
      <div class="section-head">
        <h3>Water balance</h3>
        <div class="chips" role="group" aria-label="Range">
          ${Object.keys(We).map(t=>B`<button class=${t===this._range?"on":""} @click=${()=>this._setRange(t)}>${t}</button>`)}
        </div>
      </div>
      <div class="tiles">
        <div title="What the pump's meter counted"><span class="dim">Pump delivered</span><b>${null===a.pump?"no data":ae(a.pump)}</b></div>
        <div title="Runs of the valves this pump fed at the time"><span class="dim">Valves</span><b>${ae(a.valves)}</b><span class="dim">${r(a.valves)}</span></div>
        <div title="Metered devices connected as consumers"><span class="dim">Metered consumers</span><b>${ae(a.consumers)}</b><span class="dim">${r(a.consumers)}</span></div>
        <div title="Pump minus valves minus consumers: tanks, taps, unmetered valves, leaks">
          <span class="dim">Unaccounted</span><b>${null===a.unaccounted?"–":ae(a.unaccounted)}</b
          ><span class="dim">${null===a.unaccounted?"":r(a.unaccounted)}</span>
        </div>
      </div>
      <xt-pump-chart .buckets=${a.buckets} period=${i}></xt-pump-chart>
    </section>`}_feeds(t,e){const i=this._farm.data,s=Pe(i,t.id,Date.now()),n=t=>B`<xt-mp-card .summary=${e.get(t)}></xt-mp-card>`,a=new Set,r=s.sites.map(t=>{const e=Bt(i.sites,t),n=s.mps.filter(t=>{const s=i.locations.find(e=>e.id===t);return s?.site_id&&e.has(s.site_id)});return n.forEach(t=>a.add(t)),{siteId:t,path:qt(i.sites,t),mps:n}}).sort((t,e)=>t.path.localeCompare(e.path)),o=s.mps.filter(t=>!a.has(t));return B`<section>
    ...
    </section>`}_assignForm(t){const e=this._farm.data,i=e.sites.map(t=>({v:`site:${t.id}`,l:qt(e.sites,t.id)})).sort((t,e)=>t.l.localeCompare(e.l)),s=e.locations.map(t=>({v:`location:${t.id}`,l:t.name})).sort((t,e)=>t.l.localeCompare(e.l));return B`<form class="editor" @submit=${e=>this._assign(e,t)}>
      <label
        >Assign this pump to
        <select>
    ...
    </form>`}_valveDevices(){return this._farm.valves.map(t=>this.hass?.entities[t.registry_entity]?.device_id).filter(t=>!!t)}_pumpForm(t){const e=this._deviceOf(t.meter_entity),i=[...new Set([...this._sensorsOf(e),...qe.map(e=>t[e]).filter(t=>!!t)])].sort();return B`<form class="editor" @submit=${e=>this._savePump(e,t)}>
      <label>Name <input name="name" .value=${t.name} required /></label>
      ${qe.map(e=>B`<label
          >${Ve[e]}
          <select name=${e}>
    ...
    >
      ...
      <main>
        <div class="title-row">
          <h2>${o?o.name:r===Ue?"No pump":"Pumps"}</h2>
        ...
        ${r===Ue?B`<p class="dim">Metering points no pump feeds: set a pump on their site or on them.</p>
              <div class="grid">${n.map(t=>B`<xt-mp-card .summary=${s.get(t.id)}></xt-mp-card>`)}</div>`:G}
      </main>
    </div>`}}Je.styles=[Jt,Me,r`
      section {
        margin-top: 24px;
      }
      .section-head {
    ...
    `],t([ht({attribute:!1})],Je.prototype,"hass",void 0),t([mt()],Je.prototype,"_selected",void 0),t([mt()],Je.prototype,"_range",void 0),t([mt()],Je.prototype,"_stats",void 0),t([mt()],Je.prototype,"_edit",void 0),t([mt()],Je.prototype,"_busy",void 0),t([mt()],Je.prototype,"_error",void 0),t([mt()],Je.prototype,"_connecting",void 0),customElements.get("irrigation-pumps-card")||customElements.define("irrigation-pumps-card",Je);class Ye extends dt{constructor(){super(...arguments),this.runs=[],this.metered=!0,this._shown=15}render(){const t=[...this.runs].sort((t,e)=>Date.parse(e.start)-Date.parse(t.start));return t.length?B`
      <table>
        <thead>
          <tr>
            <th>Date</th>
    ...
    `:B`<div class="empty">No runs recorded in the last 30 days.</div>`}}Ye.styles=[Jt,r`
      :host {
        display: block;
      }
      table {
    ...
    `],t([ht({attribute:!1})],Ye.prototype,"runs",void 0),t([ht({type:Boolean})],Ye.prototype,"metered",void 0),t([mt()],Ye.prototype,"_shown",void 0),customElements.get("xt-run-history")||customElements.define("xt-run-history",Ye);class Xe extends dt{constructor(){super(...arguments),this._data=yt,this._loaded=!1}setConfig(t){if(!t.device_id)throw new Error("device_id is required");this._config=t}getCardSize(){return 6}updated(){this.hass&&!this._loaded&&(this._loaded=!0,wt(this.hass).then(t=>this._data=t,()=>{}))}render(){if(!this._config)return G;const t=this._data.runs.filter(t=>t.device_id===this._config.device_id);return B`<ha-card>
  ...
  `,t([ht({attribute:!1})],Xe.prototype,"hass",void 0),t([mt()],Xe.prototype,"_config",void 0),t([mt()],Xe.prototype,"_data",void 0),t([mt()],Xe.prototype,"_loaded",void 0),customElements.get("irrigation-run-history-card")||customElements.define("irrigation-run-history-card",Xe);class Ze extends dt{connectedCallback(){super.connectedCallback(),this.setAttribute("role","progressbar"),this.setAttribute("aria-label","Loading")}}Ze.styles=[Jt,r`
      :host {
        display: inline-block;
        width: 18px;
        height: 18px;
    ...
    `],customElements.get("xt-spinner")||customElements.define("xt-spinner",Ze);const Qe={low_battery:["Low battery","Battery below 20 %","warn"],stale:["No report 36 h","The valve has not reported for more than 36 hours","warn"],missed:["Missed","A planned run in the last 24 hours did not happen","bad"],no_flow:["No water flow","The last run measured no water","bad"],flow_low:["Flow low","Mean flow of the last 30 days is well below the expected L/min","bad"],flow_high:["Flow high","Mean flow of the last 30 days is well above the expected L/min (leak?)","bad"]};class ti extends dt{constructor(){super(...arguments),this._farm=new Ht(this)}setConfig(t){if(!t.device_id)throw new Error("device_id is required");this._config=t}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;if(!this._farm.loaded)return B`<ha-card class="loading"><xt-spinner></xt-spinner></ha-card>`;const t=Date.now(),e=this._farm.summaryOf(this._config.device_id);if(!e)return B`<ha-card><div class="msg">Valve not found.</div></ha-card>`;const i=this._farm.data.locations.find(t=>t.valves.includes(e.device_id)),s=i?i.valves.map(t=>t===e.device_id?e:this._farm.summaryOf(t)).filter(t=>!!t):[],n=i?be(i,this._farm.data,s,t):null,a=n?.week??e.week,r=n?.last??e.last,o=[...new Set([...n?.badges.filter(t=>"no_valve"!==t)??[],...e.badges])],l=e.number?e.name.replace(/\s*\(\d+\)\s*$/,""):e.name,d="watering"===e.status?B`<span class="status watering"><i></i>Watering${e.since?` since ${te(e.since)}`:""}${null!==e.flow_lpm?` · ${e.flow_lpm.toFixed(1)} L/min`:""}</span>`:"offline"===e.status?B`<span class="status offline"><i></i>Offline${e.since?` for ${ie(e.since)}`:""}</span>`:B`<span class="status"><i></i>Idle</span>`,c="L"===a.unit?ae(a.liters):`${Math.round(a.minutes)} min`;return B`<ha-card>
      <div class="top">
        <div class="who">
          <div class="name-row">
            <h1>${l}</h1>
            ...
            ${null!==e.battery?B`<span class="battery ${e.badges.includes("low_battery")?"low":""}" title="Battery ${Math.round(e.battery)} %"
                  ><ha-icon icon=${ne(e.battery)}></ha-icon>${Math.round(e.battery)} %</span
                >`:G}
          </div>
          ${d}
          <div class="where">
          ...
          ${o.length?B`<div class="badges">
                ${o.map(t=>{const[e,i,s]=Qe[t]??[t,t,"warn"];return B`<span class="badge ${s}" title=${i}>${e}</span>`})}
              </div>`:G}
        </div>
        <div class="tiles">
    ...
    `],t([ht({attribute:!1})],ti.prototype,"hass",void 0),t([mt()],ti.prototype,"_config",void 0),customElements.get("irrigation-valve-header-card")||customElements.define("irrigation-valve-header-card",ti);const ei=864e5,ii=36e5,si="xt-irrigation-calendar-mode",ni="xt-irrigation-calendar-range";function ai(t){return new Date(t.getFullYear(),t.getMonth(),t.getDate())}function ri(t,e){const i=new Date(t);return i.setDate(i.getDate()+e),i}const oi=t=>String(t).padStart(2,"0"),li=t=>{const e=new Date(t);return`${oi(e.getHours())}:${oi(e.getMinutes())}`},di=t=>t>0?String(Math.round(t/6e4)):"–";function ci(t){const e=/·\s*~?([\d.,]+)\s*L\s*$/.exec(t);return e?Number(e[1].replace(",",".")):null}function pi(t){return("ran"===t.kind||"unplanned"===t.kind)&&0===t.liters}const ui="xt-irrigation-calendar-filter";function hi(t,e){try{return localStorage.getItem(t)??e}catch{return e}}function mi(t,e){try{localStorage.setItem(t,e)}catch{}}class vi extends dt{constructor(){super(...arguments),this._config=null,this._mode=["day","week","timeline"].includes(hi(si,"day"))?hi(si,"day"):"day",this._range=[1,3,7].includes(Number(hi(ni,"1")))?Number(hi(ni,"1")):1,this._anchor=ai(new Date),this._events=[],this._problemsOnly=!1,this._filter=function(){try{return{...Ft,...JSON.parse(localStorage.getItem(ui)??"{}"),status:"all"}}catch{return Ft}}(),this._farm=yt,this._farmLoaded=!1,this._offline=new Map,this._loading=!1,this._error=null,this._loadedKey=""}setConfig(t){this._config=t;const e=this._modes();e.includes(this._mode)||(this._mode=e[0])}_modes(){const t=(this._config?.modes??[]).filter(t=>["day","week","timeline"].includes(t));return t.length?t:["day","week","timeline"]}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),this._timer=window.setInterval(()=>this._load(!0),3e5)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&window.clearInterval(this._timer)}updated(){!this._farmLoaded&&this.hass?.callApi&&(this._farmLoaded=!0,wt(this.hass).then(t=>this._farm=t,()=>{}));const t=`${this._mode}|${this._range}|${this._anchor.getTime()}`;t!==this._loadedKey&&this.hass?.callApi&&(this._loadedKey=t,this._load())}_window(){if("week"===this._mode){const t=function(t){const e=ai(t);return e.setDate(e.getDate()-(e.getDay()+6)%7),e}(this._anchor);return[t,ri(t,7)]}const t=ai(this._anchor);return[t,ri(t,"timeline"===this._mode?this._range:1)]}_valveByRegistry(){const t=new Map;for(const e of this._config?.valves??[])t.set(e.registry_entity,e);return t}async _load(t=!1){if(!this.hass?.callApi)return;const[e,i]=this._window();"timeline"===this._mode&&this._loadOffline(e,i);const s=`?start=${encodeURIComponent(e.toISOString())}&end=${encodeURIComponent(i.toISOString())}`,n=this._config?.planned_entity??"calendar.irrigation_planned",a=this._config?.completed_entity??"calendar.irrigation_completed";t||(this._loading=!0),this._error=null;try{const[t,e]=await Promise.all([this.hass.callApi("GET",`calendars/${n}${s}`),this.hass.callApi("GET",`calendars/${a}${s}`)]),i=this._valveByRegistry(),r=(t,e)=>{const s=Date.parse(t.start.dateTime??t.start.date??"");let n=Date.parse(t.end.dateTime??t.end.date??"");if(!Number.isFinite(s))return null;(!Number.isFinite(n)||n<=s)&&(n=s+6e4);const a=(t.uid??"").split("#")[0],r=i.get(a);return{start:s,end:n,kind:e,key:a,name:r?.valve_name??t.summary.split(" · ")[0],summary:t.summary,liters:"planned"===e?null:ci(t.summary),path:r?.view_path}},o=(e??[]).map(t=>r(t,/Type: In progress/.test(t.description??"")?"running":"ran")).filter(t=>!!t),l=(t??[]).map(t=>r(t,"planned")).filter(t=>!!t);this._events=Ct(l,o,Date.now())}catch(t){this._error=function(t){const e=t;return e?.body?.message??e?.message??String(t)}(t)}finally{this._loading=!1,t||this.updateComplete.then(()=>this._scrollToFirst())}}async _loadOffline(t,e){const i=(this._config?.valves??[]).map(t=>t.registry_entity),s=new Map;for(let n=0;n<i.length;n+=40){const a=i.slice(n,n+40);try{const i=await this.hass.callApi("GET",`history/period/${encodeURIComponent(t.toISOString())}?end_time=${encodeURIComponent(e.toISOString())}&filter_entity_id=${a.join(",")}&minimal_response&no_attributes`);for(const n of i??[]){const i=n[0]?.entity_id;i&&s.set(i,Nt(n,t.getTime(),Math.min(e.getTime(),Date.now())))}}catch{}}this._offline=s}_scrollToFirst(){if("timeline"===this._mode)return;const[t,e]=this._window();let i=null;for(const s of this._events){if(s.end<=t.getTime()||s.start>=e.getTime())continue;const n=new Date(Math.max(s.start,t.getTime())),a=n.getHours()+n.getMinutes()/60;(null===i||a<i)&&(i=a)}const s=this.renderRoot.querySelector(".scroll");s&&null!==i&&(s.scrollTop=Math.max(0,(i-1)*this._hourPx()))}_hourPx(){return this._config?.hour_height??Math.max(36,Math.round(.72*window.innerHeight/8))}_setMode(t){this._mode=t,mi(si,t)}_setRange(t){this._range=t,mi(ni,String(t))}_shift(t){const e="week"===this._mode?7:"timeline"===this._mode?this._range:1;this._anchor=ri(this._anchor,e*t)}_open(t){if(!t)return;const e=window.location.pathname.split("/")[1]||"lovelace";window.history.pushState(null,"",`/${e}/${t}`),this.dispatchEvent(new Event("location-changed",{bubbles:!0,composed:!0}))}_rangeLabel(){const[t,e]=this._window(),i={weekday:"short",day:"numeric",month:"short"};return e.getTime()-t.getTime()<=ei?t.toLocaleDateString(void 0,i):`${t.toLocaleDateString(void 0,{day:"numeric",month:"short"})} – ${ri(e,-1).toLocaleDateString(void 0,i)}`}_placeOf(t){const e=this._farm.locationOf[t.device_id],i=e?.site_id??null;return{site:i,siteName:i?qt(this._farm.sites,i):null,mp:e?.name??null}}_visible(){const t=this._filter,e=t.site?Bt(this._farm.sites,t.site):null,i=t.search.trim().toLowerCase();return(this._config?.valves??[]).filter(t=>{const s=this._placeOf(t);return!!(!e||s.site&&e.has(s.site))&&(!i||[t.valve_name,s.mp,s.siteName].some(t=>t?.toLowerCase().includes(i)))})}_shownEvents(){if(!this._filter.site&&!this._filter.search.trim())return this._events;const t=new Set(this._visible().map(t=>t.registry_entity));return this._events.filter(e=>t.has(e.key))}_onFilter(t){this._filter=t.detail;try{localStorage.setItem(ui,JSON.stringify(t.detail))}catch{}}_legend(t){const e={planned:0,ran:0,missed:0,unplanned:0,running:0,dry:0};for(const i of t)e[i.kind]++,pi(i)&&e.dry++;const i=(t,e,i,s)=>B`<span class="lg" title=${s}><i class="sw ${t}"></i><b>${e}</b> ${i}</span>`;return B`<div class="legend">
        ...
        <div class="head">
          ...
          <div class="bar">
            ...
            <div class="datenav">
              ...
              ${i(!1,"Today",()=>this._anchor=ai(new Date))}
            </div>
          </div>
          <xt-valve-filter-bar
    ...
    `}_renderGrid(t){const[e]=this._window(),i="day"===this._mode?1:7,s=this._hourPx(),n=ai(new Date).getTime();return B`
      <div class="scroll">
        <div class="grid" style="--hour:${s}px;--days:${i}">
          <div class="hours">
            ${i>1?B`<div class="colhead"></div>`:G}
            ${Array.from({length:24},(t,e)=>B`<div class="hour">${oi(e)}:00</div>`)}
          </div>
          ${Array.from({length:i},(a,r)=>{const o=ri(e,r).getTime(),l=o+ei,d=t.filter(t=>t.start<l&&t.end>o).map(t=>({...t,start:Math.max(t.start,o),end:Math.min(Math.max(t.end,t.start+9e5),l)})),c=function(t){const e=[...t].sort((t,e)=>t.start-e.start||Mt[t.kind]-Mt[e.kind]||t.name.localeCompare(e.name)),i=[];let s=[],n=[],a=-1/0;const r=()=>{const t=s.length;for(const e of n)e.lanes=t;n=[],s=[]};for(const t of e){t.start>=a&&r();let e=s.findIndex(e=>e<=t.start);-1===e?(e=s.length,s.push(t.end)):s[e]=t.end;const o={ev:t,lane:e,lanes:0};n.push(o),i.push(o),a=Math.max(a,t.end)}return r(),i}(d),p=c.reduce((t,e)=>Math.max(t,e.lanes),1),u=i>1?40:72;return B`
              <div
                class="col ${o===n?"today":""}"
  ...
  `],t([ht({attribute:!1})],vi.prototype,"hass",void 0),t([mt()],vi.prototype,"_config",void 0),t([mt()],vi.prototype,"_mode",void 0),t([mt()],vi.prototype,"_range",void 0),t([mt()],vi.prototype,"_anchor",void 0),t([mt()],vi.prototype,"_events",void 0),t([mt()],vi.prototype,"_problemsOnly",void 0),t([mt()],vi.prototype,"_filter",void 0),t([mt()],vi.prototype,"_farm",void 0),t([mt()],vi.prototype,"_offline",void 0),t([mt()],vi.prototype,"_loading",void 0),t([mt()],vi.prototype,"_error",void 0),!customElements.get("irrigation-calendar-card")){customElements.define("irrigation-calendar-card",vi);const t=window;t.customCards=t.customCards||[],t.customCards.some(t=>"irrigation-calendar-card"===t.type)||t.customCards.push({type:"irrigation-calendar-card",name:"Irrigation Calendar",description:"Planned, ran, missed and unplanned irrigation runs as a day grid, week grid or per-valve timeline."})}const gi=r`
  .titlebar {
    display: flex;
    align-items: center;
    gap: 10px;
...
`;class fi extends dt{setConfig(t){this._config=t}getCardSize(){return 3}_delay(t){const e=this._config?.rain_snow_delay,i=e?this.hass?.states[e]:void 0;if(!e||!i)return;const s=i.attributes,n=Number(s.min??0),a=Number(s.max??7),r=Math.min(a,Math.max(n,Number(i.state)+t*Number(s.step??1)));this.hass.callService("number","set_value",{entity_id:e,value:r})}render(){if(!this._config||!this.hass)return G;const t=this._config.sleep_mode?this.hass.states[this._config.sleep_mode]:void 0,e=this._config.rain_snow_delay?this.hass.states[this._config.rain_snow_delay]:void 0,i=e?Number(e.state):NaN,s=t=>!t||"unavailable"===t.state||"unknown"===t.state;return B`<ha-card>
    ...
    `],t([ht({attribute:!1})],fi.prototype,"hass",void 0),t([mt()],fi.prototype,"_config",void 0),customElements.get("irrigation-valve-settings-card")||customElements.define("irrigation-valve-settings-card",fi);
