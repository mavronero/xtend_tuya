...
`,Wt=[["all","All"],["watering","Watering"],["attention","Attention"],["offline","Offline"]];class Bt extends dt{constructor(){super(...arguments),this.sites=[],this.value=Pt,this.counts={},this.statuses=!0}_set(t){this.value={...this.value,...t},this.dispatchEvent(new CustomEvent("xt-filter-changed",{detail:this.value,bubbles:!0,composed:!0}))}render(){const t=[...this.sites].map(t=>({id:t.id,path:Rt(this.sites,t.id)})).sort((t,e)=>t.path.localeCompare(e.path));return B`
      <select
        aria-label="Site"
  ...
  `],t([ht({attribute:!1})],Bt.prototype,"sites",void 0),t([ht({attribute:!1})],Bt.prototype,"value",void 0),t([ht({attribute:!1})],Bt.prototype,"counts",void 0),t([ht({type:Boolean})],Bt.prototype,"statuses",void 0),customElements.get("xt-valve-filter-bar")||customElements.define("xt-valve-filter-bar",Bt);const qt=864e5;function Vt(t,e=Date.now()){const i=new Date(t),s=new Date(e);s.setHours(0,0,0,0);const n=Math.floor((i.getTime()-s.getTime())/qt);return 0===n?"Today":-1===n?"Yesterday":1===n?"Tomorrow":i.toLocaleDateString(void 0,{weekday:"short",day:"numeric",month:"short"})}function Gt(t){return new Date(t).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}function Kt(t){return`${Vt(t)} ${Gt(t)}`}function Jt(t,e=Date.now()){const i=Math.round((e-t)/6e4);if(i<60)return`${i} min`;const s=Math.round(i/60);return s<48?`${s} h`:`${Math.round(s/24)} d`}function Yt(t){return`${Math.round(t).toLocaleString()} L`}function Xt(t){return t>=95?"mdi:battery":t<10?"mdi:battery-outline":"mdi:battery-"+10*Math.floor(t/10)}function Zt(t){return Math.abs(t)<1e3?`${Math.round(t)} L`:`${(t/1e3).toFixed(1)} m³`}class Qt extends dt{constructor(){super(...arguments),this.daily=[],this.unit="L"}render(){const t=Math.max(...this.daily,0),e=new Date;e.setHours(12,0,0,0);const i=this.daily.length;return this.daily.map((s,n)=>B`<span
  ...
  `],t([ht({attribute:!1})],Qt.prototype,"daily",void 0),t([ht()],Qt.prototype,"unit",void 0),customElements.get("xt-week-bars")||customElements.define("xt-week-bars",Qt);const te={low_battery:"Low battery",stale:"No report 36 h",missed:"Missed",no_flow:"No water flow"},ee={low_battery:"Battery below 20 %",stale:"The valve has not reported for more than 36 hours",missed:"A planned run in the last 24 hours did not happen",no_flow:"The last run measured no water"};function ie(t){const e=[Kt(t.start),`${Math.round(t.minutes)} min`];return null!==t.liters&&e.push(`${Math.round(t.liters)} L`),e.join(" · ")}function se(t){return(t.number?t.name.replace(/\s*\(\d+\)\s*$/,""):t.name)||t.name}class ne extends dt{_open(){this.summary&&this.dispatchEvent(new CustomEvent("xt-valve-open",{detail:this.summary.view_path,bubbles:!0,composed:!0}))}_status(t){if("watering"===t.status){const e=null!==t.flow_lpm?` · ${t.flow_lpm.toFixed(1)} L/min`:"";return B`<span class="status watering" title="Watering now"><i></i>Watering${t.since?` since ${Gt(t.since)}`:""}${e}</span>`}return"offline"===t.status?B`<span class="status offline" title="Not reachable"><i></i>Offline${t.since?` for ${Jt(t.since)}`:""}</span>`:B`<span class="status idle" title="Online, not watering"><i></i>Idle</span>`}_week(t){const e=t.week.unit,i="L"===e?`${Math.round(t.week.liters)} L`:`${Math.round(t.week.minutes)} min`;return B`<div class="week">
      ...
      <div class="head">
        ...
        ${null!==t.battery?B`<span class="battery ${t.badges.includes("low_battery")?"low":""}" title="Battery ${Math.round(t.battery)} %"
              ><ha-icon icon=${Xt(t.battery)}></ha-icon>${Math.round(t.battery)} %</span
            >`:G}
      </div>
      ...
      <dl>
        ...
        <dd title="Last run: start · duration${t.has_flow_meter?" · water":""}">${t.last?ie(t.last):"–"}</dd>
        <dt title="Next planned run"><ha-icon icon="mdi:calendar-clock"></ha-icon></dt>
        <dd title="Next planned run: start · duration">${t.next?ie(t.next):"–"}</dd>
      </dl>
      ${this._week(t)}
      ${t.badges.length?B`<div class="badges">
            ${t.badges.map(e=>B`<span class="badge ${e}" title=${ee[e]}>${te[e]}${"missed"===e&&t.missed>1?` ${t.missed}`:""}</span>`)}
          </div>`:G}
    </ha-card>`}}ne.styles=[jt,r`
    :host {
      display: block;
    }
    ha-card {
  ...
  `],t([ht({attribute:!1})],ne.prototype,"summary",void 0),customElements.get("xt-valve-card")||customElements.define("xt-valve-card",ne);class ae extends dt{constructor(){super(...arguments),this.collapsed=!1}render(){const t=this.section;return t?B`
  ...
  `],t([ht({attribute:!1})],ae.prototype,"section",void 0),t([ht({type:Boolean,reflect:!0})],ae.prototype,"collapsed",void 0),customElements.get("xt-valve-section")||customElements.define("xt-valve-section",ae);const re="xt-valves-filter";class oe extends dt{constructor(){super(...arguments),this._filter=function(){try{return{...Pt,...JSON.parse(localStorage.getItem(re)??"{}")}}catch{return Pt}}(),this._farm=new Dt(this)}setConfig(t){this._config=t}getCardSize(){return 12}_onFilter(t){this._filter=t.detail,function(t){try{localStorage.setItem(re,JSON.stringify(t))}catch{}}(t.detail)}_onOpen(t){Ft(t.detail)}render(){if(!this._config||!this.hass)return G;if(!this._farm.loaded)return B`<ha-card><div class="msg">Loading valves…</div></ha-card>`;const t=this._farm.summaries(),e=this._farm.data,i=this._config.site??null,s={...this._filter,site:i??this._filter.site},n=Ht(t,{...s,status:"all"},e.sites),a={};for(const t of["all","watering","attention","offline"])a[t]="all"===t?n.length:Ht(n,{...Pt,status:t},e.sites).length;const r=function(t,e,i=Tt){const s=(t,e)=>t.name.localeCompare(e.name),n=(t,e)=>({key:t,title:Ot[t],groups:[{site:null,title:"",valves:[...e].sort(s)}],count:e.length}),a=t.filter(t=>"offline"!==t.status),r=a.filter(t=>t.location),o=new Map;for(const t of r){const e=t.site?.id??null;o.set(e,[...o.get(e)??[],t])}const l=[...o.entries()].map(([t,i])=>({site:t,title:t?Rt(e,t):"No site",valves:i.sort(s)})).sort((t,e)=>null===t.site?1:null===e.site?-1:t.title.localeCompare(e.title)),d={watering:n("watering",a.filter(t=>"watering"===t.status)),attention:n("attention",a.filter(It)),sites:{key:"sites",title:Ot.sites,groups:l,count:r.length},offline:n("offline",t.filter(t=>"offline"===t.status)),unassigned:n("unassigned",a.filter(t=>!t.location))};return i.map(t=>d[t]).filter(t=>t.count>0)}(Ht(n,{...Pt,status:s.status},e.sites),e.sites,this._config.sections??Tt),o=new Set(this._config.collapsed??["offline"]);return B`
  ...
  `],t([ht({attribute:!1})],ue.prototype,"summary",void 0),customElements.get("xt-site-card")||customElements.define("xt-site-card",ue);class he extends dt{constructor(){super(...arguments),this.sites=[],this.selected=null,this.counts={},this.noSite=!1,this._closed=new Set}_open(t){this.dispatchEvent(new CustomEvent("xt-site-open",{detail:t,bubbles:!0,composed:!0}))}_toggle(t,e){t.stopPropagation();const i=new Set(this._closed);i.has(e)?i.delete(e):i.add(e),this._closed=i}_node(t,e){const i=de(this.sites,t.id),s=this._closed.has(t.id);return B`
      <button
    ...
    `}render(){return B`
      ...
      ${this.noSite?B`<button class="node ${this.selected===le?"on":""}" @click=${()=>this._open(le)}>
            <span class="chev"></span><span class="label dim">No site</span>
            <span class="count">${this.counts[le]??""}</span>
          </button>`:G}
    `}}he.styles=[jt,r`
    :host {
      display: flex;
  ...
  `],t([ht({attribute:!1})],he.prototype,"sites",void 0),t([ht({attribute:!1})],he.prototype,"selected",void 0),t([ht({attribute:!1})],he.prototype,"counts",void 0),t([ht({type:Boolean})],he.prototype,"noSite",void 0),t([mt()],he.prototype,"_closed",void 0),customElements.get("xt-site-tree")||customElements.define("xt-site-tree",he);const me={no_valve:["No valve","No valve is assigned to this metering point","warn"],low_battery:["Low battery","The valve's battery is below 20 %","warn"],stale:["No report 36 h","The valve has not reported for more than 36 hours","warn"],missed:["Missed","A planned run in the last 24 hours did not happen","bad"],no_flow:["No water flow","The last run here measured no water","bad"],flow_low:["Flow low","Mean flow of the last 30 days is well below the expected L/min","bad"],flow_high:["Flow high","Mean flow of the last 30 days is well above the expected L/min (leak?)","bad"]},ve={watering:"Watering",idle:"Idle",offline:"Offline"};function ge(t){const e=[Kt(t.start),`${Math.round(t.minutes)} min`];return null!==t.liters&&e.push(`${Math.round(t.liters)} L`),e.join(" · ")}class fe extends dt{constructor(){super(...arguments),this.editable=!1}_openValve(t,e){t.stopPropagation(),this.dispatchEvent(new CustomEvent("xt-valve-open",{detail:e.view_path,bubbles:!0,composed:!0}))}_valve(t){return B`<button class="valve ${t.status}" @click=${e=>this._openValve(e,t)} title="Open valve ${t.name}">
      <ha-icon icon="mdi:valve"></ha-icon>
      <span class="num">${t.number?`#${t.number}`:t.name}</span>
      <i></i><span>${ve[t.status]}</span>
      ...
      <dl>
        ...
        <dd title="Last run here: start · duration · water">${t.last?ge(t.last):"–"}</dd>
        <dt title="Next planned run"><ha-icon icon="mdi:calendar-clock"></ha-icon></dt>
        <dd title="Next planned run: start · duration">${t.next?ge(t.next):"–"}</dd>
      </dl>
      <div class="week">
        <ha-icon icon="mdi:chart-bar" title="Last 7 days"></ha-icon>
        <xt-week-bars .daily=${t.week.daily} unit=${e}></xt-week-bars>
      ...
      ${this._flow(t)}
      ${t.badges.length?B`<div class="badges">
            ${t.badges.map(e=>{const[i,s,n]=me[e];return B`<span class="badge ${n}" title=${s}>${i}${"missed"===e&&t.missed>1?` ${t.missed}`:""}</span>`})}
          </div>`:G}
    </ha-card>`}}fe.styles=[jt,r`
    :host {
      display: block;
    }
    ha-card {
  ...
  `],t([ht({attribute:!1})],fe.prototype,"summary",void 0),t([ht({type:Boolean})],fe.prototype,"editable",void 0),customElements.get("xt-mp-card")||customElements.define("xt-mp-card",fe);const _e={watering:"Watering",idle:"Idle",offline:"Offline"};function xe(t){return new Date(t).toLocaleDateString(void 0,{day:"numeric",month:"short",year:"numeric"})}class be extends dt{constructor(){super(...arguments),this.sites=[],this.valves=[],this.busy=!1,this.error=null}_fire(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_save(t){t.preventDefault();const e=t.target,i=t=>e.elements.namedItem(t).value,s=i("expected_lpm").trim();this._fire("xt-mp-save",{name:i("name"),description:i("description"),expected_lpm:""===s?null:Number(s),site_id:i("site_id")||null})}_valveLine(t,e){return B`<div class="valve">
      <ha-icon icon="mdi:valve"></ha-icon>
      <span class="num">${t?.label??e}</span>
      ${t?B`<i class=${t.status}></i><span>${_e[t.status]}</span>`:G}
      ${null!=t?.battery?B`<span class="dim"><ha-icon icon=${Xt(t.battery)}></ha-icon>${Math.round(t.battery)} %</span>`:G}
        ...
        ${s.length?B`<section>
              ...
              <ul>
                ${s.map(t=>B`<li>
                    ...
                    <span class="dim"
                      >${t.begin?xe(t.begin):"from the start"} – ${t.end?xe(t.end):"now"}</span
                    >
                  </li>`)}
              </ul>
            </section>`:G}
    ...
    `],t([ht({attribute:!1})],be.prototype,"mp",void 0),t([ht({attribute:!1})],be.prototype,"sites",void 0),t([ht({attribute:!1})],be.prototype,"valves",void 0),t([ht({type:Boolean})],be.prototype,"busy",void 0),t([ht()],be.prototype,"error",void 0),customElements.get("xt-mp-editor")||customElements.define("xt-mp-editor",be);const ye=r`
    :host {
      display: block;
    }
    .layout {
...
`,$e="xtend_tuya/irrigation_locations";function we(){return new URLSearchParams(window.location.search).get("site")}class ke extends dt{constructor(){super(...arguments),this._selected=we(),this._edit=!1,this._editing=null,this._busy=!1,this._error=null,this._farm=new Dt(this),this._onLocation=()=>{this._selected=we()}}setConfig(t){}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),window.addEventListener("location-changed",this._onLocation),window.addEventListener("popstate",this._onLocation)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("location-changed",this._onLocation),window.removeEventListener("popstate",this._onLocation)}_open(t){const e=new URL(window.location.href);t?e.searchParams.set("site",t):e.searchParams.delete("site"),window.history.pushState(null,"",e.pathname+e.search),this._selected=t,this._error=null}async _post(t){if(!this.hass?.callApi)return!1;this._busy=!0,this._error=null;try{return await this.hass.callApi("POST",$e,t),await this._farm.refresh(!0),!0}catch(t){const e=t;return this._error=e.body?.error??e.message??String(t),!1}finally{this._busy=!1}}async _createSite(t,e){const i=t.querySelector("input");i.value.trim()&&await this._post({action:"create_site",name:i.value,parent_id:e})&&(i.value="")}async _saveSite(t,e){const i=t.querySelector("input").value,s=t.querySelector("select").value||null;await this._post({action:"update_site",id:e.id,name:i,parent_id:s})}async _deleteSite(t){await this._post({action:"delete_site",id:t.id})&&this._open(t.parent_id)}_header(t,e){const i=[{id:null,name:"All sites"}];if(t&&t.id!==le){const e=new Map(this._farm.data.sites.map(t=>[t.id,t])),s=[];for(let i=e.get(t.id);i&&s.length<20;i=i.parent_id?e.get(i.parent_id):void 0)s.unshift(i);i.push(...s.map(t=>({id:t.id,name:t.name})))}else t&&i.push({id:le,name:"No site"});const s=i[i.length-1].name;return B`<div class="header">
      ...
      <div class="figures">
        ${t?B`
              ...
              <span title="Last 7 days"
                ><xt-week-bars .daily=${t.week.daily}></xt-week-bars>${t.week.runs} runs · ${Yt(t.week.liters)}</span
              >
    ...
    ></xt-mp-editor>`}_addMp(t){return B`<form class="editor" @submit=${e=>(e.preventDefault(),this._createMp(e.target,t))}>
      ...
      <button type="submit" ?disabled=${this._busy}>Add</button>
    </form>`}render(){if(!this.hass)return G;if(!this._farm.loaded)return B`<ha-card><div class="msg">Loading sites…</div></ha-card>`;const t=this._farm.data,e=this._farm.summaries(),i=Date.now(),s=t.locations.map(s=>pe(s,t,e,i)),n=new Map(s.map(t=>[t.id,t])),a=t.locations.some(t=>!t.site_id),r=this._selected&&(this._selected===le||t.sites.some(t=>t.id===this._selected))?this._selected:null,o=r&&r!==le?t.sites.find(t=>t.id===r)??null:null,l=r?ce(r,t,s):null,d=r?l.children:[...de(t.sites,null).map(t=>t.id),...a?[le]:[]],c=d.map(e=>ce(e,t,s)),p=r?t.locations.filter(t=>r===le?!t.site_id:t.site_id===r).sort((t,e)=>t.name.localeCompare(e.name)):[],u={};for(const e of t.sites)u[e.id]=t.locations.filter(i=>Ut(t.sites,e.id).has(i.site_id??"")).length;u[le]=t.locations.filter(t=>!t.site_id).length;const h=s.flatMap(t=>t.valves),m={sites:t.sites.length,mps:t.locations.length,valves:h.length,online:h.filter(t=>"offline"!==t.status).length},v=this._editing?t.locations.find(t=>t.id===this._editing):void 0;return B`<div
      class="layout"
      @xt-site-open=${t=>this._open(t.detail)}
      @xt-valve-open=${t=>Ft(t.detail)}
    ...
    >
      ...
      <main>
        ${this._header(l,m)}
        ${this._error&&!v?B`<div class="msg err">${this._error}</div>`:G}
        ${this._farm.error?B`<div class="msg err">Could not load farm data: ${this._farm.error}</div>`:G}
        ${this._edit&&o?this._editSite(o):G}
        ${c.length||this._edit&&r!==le?B`<h3>${r?"Sub-sites":"Sites"} <span class="count">${c.length}</span></h3>
              <div class="grid">${c.map(t=>B`<xt-site-card .summary=${t}></xt-site-card>`)}</div>
              ${this._edit&&r!==le?this._addSite(r):G}`:G}
        ${p.length||this._edit&&r?B`<h3>Metering points <span class="count">${p.length}</span></h3>
              ...
              ${this._edit&&r?this._addMp(r===le?null:r):G}`:G}
        ${r||t.sites.length?G:B`<div class="msg">No sites yet. Sites are created from the Tuya rooms once the valves report them, or by hand in Edit.</div>`}
      </main>
      ${v?this._editor(v,e):G}
    </div>`}}ke.styles=[jt,ye],t([ht({attribute:!1})],ke.prototype,"hass",void 0),t([mt()],ke.prototype,"_selected",void 0),t([mt()],ke.prototype,"_edit",void 0),t([mt()],ke.prototype,"_editing",void 0),t([mt()],ke.prototype,"_busy",void 0),t([mt()],ke.prototype,"_error",void 0),customElements.get("irrigation-sites-card")||customElements.define("irrigation-sites-card",ke);const Se=1e3;function Ee(t,e){return(null===t.begin||t.begin<=e)&&(null===t.end||e<t.end)}function Ae(t,e,i){const s=(e,s)=>t.pumpAssignments.find(t=>t.target_kind===e&&t.target_id===s&&Ee(t,i))?.pump_id??null,n=s("location",e.id);if(n)return n;const a=new Map(t.sites.map(t=>[t.id,t]));for(let t=e.site_id?a.get(e.site_id):void 0,i=0;t&&i<20;i++){const e=s("site",t.id);if(e)return e;t=t.parent_id?a.get(t.parent_id):void 0}return null}function Me(t,e,i){const s=t.pumpAssignments.filter(t=>t.pump_id===e&&"site"===t.target_kind&&Ee(t,i)).map(t=>t.target_id),n=[],a=[],r=e=>{const i=new Map(t.sites.map(t=>[t.id,t]));for(let t=e.site_id?i.get(e.site_id):void 0,n=0;t&&n<20;n++){if(s.includes(t.id))return!0;t=t.parent_id?i.get(t.parent_id):void 0}return!1};for(const s of t.locations){const o=Ae(t,s,i);o===e?n.push(s.id):o&&r(s)&&a.push({mp:s.id,pump:o})}return{sites:s,mps:n,overridden:a}}function Ce(t,e){const i=new Date(t);return i.setMinutes(0,0,0),"day"===e&&i.setHours(0),i.getTime()}const Le="__no_pump__";class Ne extends dt{constructor(){super(...arguments),this.items=[],this.selected=null}render(){return this.items.map(t=>B`<button
        class="node ${t.id===this.selected?"on":""}"
        aria-current=${t.id===this.selected?"page":"false"}
        @click=${()=>this.dispatchEvent(new CustomEvent("xt-pump-open",{detail:t.id,bubbles:!0,composed:!0}))}
      >
        ${t.id===Le?B`<span class="dot none"></span>`:B`<span class="dot ${t.state}" title=${"unknown"===t.state?"No data from the pump":t.state}></span>`}
        <span class="label ${t.id===Le?"dim":""}">${t.name}</span>
        <span class="count">${t.count}</span>
      </button>`)}}Ne.styles=[jt,r`
      :host {
        display: flex;
        flex-direction: column;
        gap: 1px;
    ...
    `],t([ht({attribute:!1})],Ne.prototype,"items",void 0),t([ht({attribute:!1})],Ne.prototype,"selected",void 0),customElements.get("xt-pump-list")||customElements.define("xt-pump-list",Ne);const ze=160;class De extends dt{constructor(){super(...arguments),this.buckets=[],this.period="hour"}_label(t){const e=new Date(t);return"hour"===this.period?e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):e.toLocaleDateString(void 0,{weekday:"short",day:"numeric"})}render(){const t=this.buckets.length;if(!t)return G;const e=Math.max(1,...this.buckets.map(t=>Math.max(t.pump??0,t.valves+t.consumers))),i=100/t,s=t=>t/e*142,n=Math.ceil(t/8);return B`
      <svg viewBox="0 0 100 ${ze}" preserveAspectRatio="none" role="img" aria-label="Pump delivery against valve and consumer use">
    ...
    `],t([ht({attribute:!1})],De.prototype,"buckets",void 0),t([ht()],De.prototype,"period",void 0),customElements.get("xt-pump-chart")||customElements.define("xt-pump-chart",De);class Pe extends dt{constructor(){super(...arguments),this.devices=[],this.exclude=[],this.placeholder="Search devices by name, area or model",this._q=""}render(){const t=this._q.trim().toLowerCase(),e=t?this.devices.filter(t=>!this.exclude.includes(t.id)).filter(e=>[e.name,e.area,e.model].some(e=>e?.toLowerCase().includes(t))).slice(0,30):[];return B`
    ...
    `}_pick(t){this._q="",this.dispatchEvent(new CustomEvent("xt-device-picked",{detail:t,bubbles:!0,composed:!0}))}}Pe.styles=[jt,r`
      :host {
        display: flex;
        flex-direction: column;
        gap: 4px;
    ...
    `],t([ht({attribute:!1})],Pe.prototype,"devices",void 0),t([ht({attribute:!1})],Pe.prototype,"exclude",void 0),t([ht()],Pe.prototype,"placeholder",void 0),t([mt()],Pe.prototype,"_q",void 0),customElements.get("xt-device-picker")||customElements.define("xt-device-picker",Pe);const Oe={"24h":{ms:864e5,period:"hour"},"7d":{ms:6048e5,period:"day"},"30d":{ms:2592e6,period:"day"}},Te="xt-pumps-range",Ue=["meter_entity","flow_entity","pressure_entity","status_entity"],Re={meter_entity:"Water meter (m³ total)",flow_entity:"Flow rate",pressure_entity:"Pressure",status_entity:"Status"},Ie={meter_entity:/_fct_total_delivered_flow_mc$/,flow_entity:/_vf_flowliter$/,pressure_entity:/_vp_pressurebar$/,status_entity:/_pumpstatus$/};function He(){return new URLSearchParams(window.location.search).get("pump")}class Fe extends dt{constructor(){super(...arguments),this._selected=He(),this._range=function(){try{const t=localStorage.getItem(Te);return t&&t in Oe?t:"7d"}catch{return"7d"}}(),this._stats={},this._edit=!1,this._busy=!1,this._error=null,this._connecting=null,this._statsKey="",this._farm=new Dt(this),this._onLocation=()=>{this._selected=He()}}setConfig(t){}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),window.addEventListener("location-changed",this._onLocation),window.addEventListener("popstate",this._onLocation)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("location-changed",this._onLocation),window.removeEventListener("popstate",this._onLocation)}updated(){const t=`${this._range}|${this._farm.data.pumps.length}|${this._farm.data.pumpConnections.length}`;this.hass?.callApi&&this._farm.loaded&&t!==this._statsKey&&(this._statsKey=t,this._loadStats())}async _loadStats(){const{ms:t}=Oe[this._range],e=new Date(Date.now()-t).toISOString();try{const t=await this.hass.callApi("GET",`xtend_tuya/pump_stats?period=hour&start=${encodeURIComponent(e)}`);this._stats=t.series??{}}catch(t){this._error=`Could not load pump statistics: ${t instanceof Error?t.message:String(t)}`}}_state(t){return t?this.hass?.states[t]:void 0}_num(t){const e=this._state(t),i=Number(e?.state);return e&&""!==e.state&&Number.isFinite(i)?i:null}_pumpState(t){const e=this._state(t.status_entity)?.state,i=this._num(t.flow_entity),s=this._state(t.meter_entity)?.state;return s&&"unknown"!==s&&"unavailable"!==s?"Go"===e||null!==i&&i>0?"running":"idle":"unknown"}_devices(){const t=this.hass?.areas??{};return Object.values(this.hass?.devices??{}).map(e=>({id:e.id,name:e.name_by_user||e.name||e.id,area:e.area_id?t[e.area_id]?.name??null:null,model:e.model??null}))}_deviceName(t){const e=this.hass?.devices[t];return e&&(e.name_by_user||e.name)||t}_sensorsOf(t){return t&&this.hass?Object.values(this.hass.entities).filter(e=>e.device_id===t&&e.entity_id.startsWith("sensor.")).map(t=>t.entity_id).sort():[]}_deviceOf(t){return t?this.hass?.entities[t]?.device_id??null:null}_open(t){const e=new URL(window.location.href);t?e.searchParams.set("pump",t):e.searchParams.delete("pump"),window.history.pushState(null,"",e.pathname+e.search),this._selected=t,this._error=null,this._connecting=null}_setRange(t){this._range=t;try{localStorage.setItem(Te,t)}catch{}}async _post(t){if(!this.hass?.callApi)return null;this._busy=!0,this._error=null;try{const e=await this.hass.callApi("POST","xtend_tuya/irrigation_locations",t);return await this._farm.refresh(!0),this._statsKey="",e}catch(t){const e=t;return this._error=e.body?.error??e.message??String(t),null}finally{this._busy=!1}}async _createPump(t){const e=this._sensorsOf(t),i=t=>e.find(e=>Ie[t].test(e))??null,s=i("meter_entity");if(!s)return void(this._error=`${this._deviceName(t)} has no water meter sensor (…_fct_total_delivered_flow_mc). Create the pump from its meter's device.`);const n=await this._post({action:"create_pump",name:this._deviceName(t),meter_entity:s,flow_entity:i("flow_entity"),pressure_entity:i("pressure_entity"),status_entity:i("status_entity")}),a=n?.pump;a&&this._open(a.id)}_savePump(t,e){t.preventDefault();const i=t.target,s=t=>i.elements.namedItem(t).value,n={action:"update_pump",id:e.id,name:s("name")};for(const t of Ue)n[t]=s(t)||null;this._post(n)}_assign(t,e){t.preventDefault();const i=t.target.querySelector("select"),[s,n]=i.value.split(":");n&&this._post({action:"assign_pump",pump_id:e.id,target_kind:s,target_id:n})}_connect(t,e){t.preventDefault();const i=t.target,s=t=>i.elements.namedItem(t).value;this._post({action:"connect_device",pump_id:e.id,device_id:this._connecting,role:s("role"),meter_entity:s("meter_entity")||null}).then(t=>{t&&(this._connecting=null)})}_figures(t,e){const i=this._num(t.flow_entity),s=this._num(t.pressure_entity),n=this._state(t.status_entity)?.state,a=this._pumpState(t);return B`<div class="figures">
      ...
      >
    </div>`}_balance(t){const{ms:e,period:i}=Oe[this._range],s=Date.now(),n=function(t,e,i,s,n,a){const r=new Map,o=t=>{const e=Ce(t,a);let i=r.get(e);return i||r.set(e,i={start:e,pump:null,valves:0,consumers:0}),i},l="hour"===a?36e5:864e5;for(let t=Ce(s,a);t<n;t+=l)o(t);let d=null;for(const t of i[e.meter_entity]??[]){if(t.start<s||t.start>=n||"number"!=typeof t.change)continue;const e=o(t.start);e.pump=(e.pump??0)+t.change*Se,d=(d??0)+t.change*Se}let c=0;for(const i of t.runs){const a=Date.parse(i.end);if(a<s||a>=n||"number"!=typeof i.liters)continue;const r=t.locations.find(t=>t.assignments.some(t=>t.device_id===i.device_id&&Ee(t,a)));r&&Ae(t,r,a)===e.id&&(c+=i.liters,o(Date.parse(i.start)).valves+=i.liters)}let p=0;for(const a of function(t,e,i,s){return t.pumpConnections.filter(t=>t.pump_id===e&&(null===t.begin||t.begin<s)&&(null===t.end||t.end>i))}(t,e.id,s,n))if("consumer"===a.role&&a.meter_entity)for(const t of i[a.meter_entity]??[])t.start<s||t.start>=n||"number"!=typeof t.change||!Ee(a,t.start)||(p+=t.change*Se,o(t.start).consumers+=t.change*Se);return{pump:d,valves:c,consumers:p,unaccounted:null===d?null:d-c-p,buckets:[...r.values()].sort((t,e)=>t.start-e.start)}}(this._farm.data,t,this._stats,s-e,s,i),a=t=>n.pump?` · ${Math.round(t/n.pump*100)} %`:"";return B`<section>
      <div class="section-head">
        <h3>Water balance</h3>
        <div class="chips" role="group" aria-label="Range">
          ${Object.keys(Oe).map(t=>B`<button class=${t===this._range?"on":""} @click=${()=>this._setRange(t)}>${t}</button>`)}
        </div>
      </div>
      <div class="tiles">
    ...
    </section>`}_feeds(t,e){const i=this._farm.data,s=Me(i,t.id,Date.now()),n=t=>B`<xt-mp-card .summary=${e.get(t)}></xt-mp-card>`,a=new Set,r=s.sites.map(t=>{const e=Ut(i.sites,t),n=s.mps.filter(t=>{const s=i.locations.find(e=>e.id===t);return s?.site_id&&e.has(s.site_id)});return n.forEach(t=>a.add(t)),{siteId:t,path:Rt(i.sites,t),mps:n}}).sort((t,e)=>t.path.localeCompare(e.path)),o=s.mps.filter(t=>!a.has(t));return B`<section>
    ...
    </section>`}_assignForm(t){const e=this._farm.data,i=e.sites.map(t=>({v:`site:${t.id}`,l:Rt(e.sites,t.id)})).sort((t,e)=>t.l.localeCompare(e.l)),s=e.locations.map(t=>({v:`location:${t.id}`,l:t.name})).sort((t,e)=>t.l.localeCompare(e.l));return B`<form class="editor" @submit=${e=>this._assign(e,t)}>
      <label
        >Assign this pump to
        <select>
    ...
    </form>`}_valveDevices(){return this._farm.valves.map(t=>this.hass?.entities[t.registry_entity]?.device_id).filter(t=>!!t)}_pumpForm(t){const e=this._deviceOf(t.meter_entity),i=[...new Set([...this._sensorsOf(e),...Ue.map(e=>t[e]).filter(t=>!!t)])].sort();return B`<form class="editor" @submit=${e=>this._savePump(e,t)}>
      <label>Name <input name="name" .value=${t.name} required /></label>
      ${Ue.map(e=>B`<label
          >${Re[e]}
          <select name=${e}>
      ...
      <button type="submit" ?disabled=${this._busy}>Save</button>
    </form>`}render(){if(!this.hass)return G;if(!this._farm.loaded)return B`<ha-card><div class="msg">Loading pumps…</div></ha-card>`;const t=this._farm.data,e=Date.now(),i=this._farm.summaries(),s=new Map(t.locations.map(s=>[s.id,pe(s,t,i,e)])),n=t.locations.filter(t=>!t.pump),a=[...t.pumps].sort((t,e)=>t.name.localeCompare(e.name)).map(i=>({id:i.id,name:i.name,state:this._pumpState(i),count:Me(t,i.id,e).mps.length}));n.length&&a.push({id:Le,name:"No pump",state:"unknown",count:n.length});const r=this._selected&&a.some(t=>t.id===this._selected)?this._selected:a[0]?.id??null,o=r&&r!==Le?t.pumps.find(t=>t.id===r)??null:null,l=!!this.hass.user?.is_admin,d=o?Me(t,o.id,e).mps:[],c=d.reduce((t,e)=>t+(s.get(e)?.valves.length??0),0);return B`<div
      class="layout"
    ...
    >
      ...
      <main>
        <div class="title-row">
          <h2>${o?o.name:r===Le?"No pump":"Pumps"}</h2>
        ...
        ${r===Le?B`<p class="dim">Metering points no pump feeds: set a pump on their site or on them.</p>
              <div class="grid">${n.map(t=>B`<xt-mp-card .summary=${s.get(t.id)}></xt-mp-card>`)}</div>`:G}
      </main>
    </div>`}}Fe.styles=[jt,ye,r`
      section {
        margin-top: 24px;
      }
      .section-head {
    ...
    `],t([ht({attribute:!1})],Fe.prototype,"hass",void 0),t([mt()],Fe.prototype,"_selected",void 0),t([mt()],Fe.prototype,"_range",void 0),t([mt()],Fe.prototype,"_stats",void 0),t([mt()],Fe.prototype,"_edit",void 0),t([mt()],Fe.prototype,"_busy",void 0),t([mt()],Fe.prototype,"_error",void 0),t([mt()],Fe.prototype,"_connecting",void 0),customElements.get("irrigation-pumps-card")||customElements.define("irrigation-pumps-card",Fe);class je extends dt{constructor(){super(...arguments),this.runs=[],this.metered=!0,this._shown=15}render(){const t=[...this.runs].sort((t,e)=>Date.parse(e.start)-Date.parse(t.start));return t.length?B`
      <table>
        <thead>
          <tr>
            <th>Date</th>
    ...
    `:B`<div class="empty">No runs recorded in the last 30 days.</div>`}}je.styles=[jt,r`
      :host {
        display: block;
      }
      table {
    ...
    `],t([ht({attribute:!1})],je.prototype,"runs",void 0),t([ht({type:Boolean})],je.prototype,"metered",void 0),t([mt()],je.prototype,"_shown",void 0),customElements.get("xt-run-history")||customElements.define("xt-run-history",je);class We extends dt{constructor(){super(...arguments),this._data=yt,this._loaded=!1}setConfig(t){if(!t.device_id)throw new Error("device_id is required");this._config=t}getCardSize(){return 6}updated(){this.hass&&!this._loaded&&(this._loaded=!0,wt(this.hass).then(t=>this._data=t,()=>{}))}render(){if(!this._config)return G;const t=this._data.runs.filter(t=>t.device_id===this._config.device_id);return B`<ha-card>
  ...
  `,t([ht({attribute:!1})],We.prototype,"hass",void 0),t([mt()],We.prototype,"_config",void 0),t([mt()],We.prototype,"_data",void 0),t([mt()],We.prototype,"_loaded",void 0),customElements.get("irrigation-run-history-card")||customElements.define("irrigation-run-history-card",We);class Be extends dt{connectedCallback(){super.connectedCallback(),this.setAttribute("role","progressbar"),this.setAttribute("aria-label","Loading")}}Be.styles=[jt,r`
      :host {
        display: inline-block;
        width: 18px;
        height: 18px;
    ...
    `],customElements.get("xt-spinner")||customElements.define("xt-spinner",Be);const qe={low_battery:["Low battery","Battery below 20 %","warn"],stale:["No report 36 h","The valve has not reported for more than 36 hours","warn"],missed:["Missed","A planned run in the last 24 hours did not happen","bad"],no_flow:["No water flow","The last run measured no water","bad"],flow_low:["Flow low","Mean flow of the last 30 days is well below the expected L/min","bad"],flow_high:["Flow high","Mean flow of the last 30 days is well above the expected L/min (leak?)","bad"]};class Ve extends dt{constructor(){super(...arguments),this._farm=new Dt(this)}setConfig(t){if(!t.device_id)throw new Error("device_id is required");this._config=t}getCardSize(){return 3}render(){if(!this._config||!this.hass)return G;if(!this._farm.loaded)return B`<ha-card class="loading"><xt-spinner></xt-spinner></ha-card>`;const t=Date.now(),e=this._farm.summaries(),i=e.find(t=>t.device_id===this._config.device_id);if(!i)return B`<ha-card><div class="msg">Valve not found.</div></ha-card>`;const s=this._farm.data.locations.find(t=>t.valves.includes(i.device_id)),n=s?pe(s,this._farm.data,e,t):null,a=n?.week??i.week,r=n?.last??i.last,o=[...new Set([...n?.badges.filter(t=>"no_valve"!==t)??[],...i.badges])],l=i.number?i.name.replace(/\s*\(\d+\)\s*$/,""):i.name,d="watering"===i.status?B`<span class="status watering"><i></i>Watering${i.since?` since ${Gt(i.since)}`:""}${null!==i.flow_lpm?` · ${i.flow_lpm.toFixed(1)} L/min`:""}</span>`:"offline"===i.status?B`<span class="status offline"><i></i>Offline${i.since?` for ${Jt(i.since)}`:""}</span>`:B`<span class="status"><i></i>Idle</span>`,c="L"===a.unit?Zt(a.liters):`${Math.round(a.minutes)} min`;return B`<ha-card>
      <div class="top">
        <div class="who">
          <div class="name-row">
            <h1>${l}</h1>
            ${i.number?B`<span class="num" title="Valve number">#${i.number}</span>`:G}
            ${null!==i.battery?B`<span class="battery ${i.badges.includes("low_battery")?"low":""}" title="Battery ${Math.round(i.battery)} %"
                  ><ha-icon icon=${Xt(i.battery)}></ha-icon>${Math.round(i.battery)} %</span
                >`:G}
          </div>
          ${d}
          <div class="where">
            ${s?B`<span title="Metering point"><ha-icon icon="mdi:map-marker-outline"></ha-icon>${s.name}</span>
                  ${i.site?B`<span title="Site"><ha-icon icon="mdi:sprout-outline"></ha-icon>${i.site.name}</span>`:G}`:B`<span class="dim">No metering point</span>`}
        ...
        <div class="tiles">
          ...
          <div title="Next planned run">
            ...
            <b>${i.next?Kt(i.next.start):"–"}</b>
            <span class="dim">${i.next?`${Math.round(i.next.minutes)} min`:"nothing planned"}</span>
          </div>
    ...
    `],t([ht({attribute:!1})],Ve.prototype,"hass",void 0),t([mt()],Ve.prototype,"_config",void 0),customElements.get("irrigation-valve-header-card")||customElements.define("irrigation-valve-header-card",Ve);const Ge=864e5,Ke=36e5,Je="xt-irrigation-calendar-mode",Ye="xt-irrigation-calendar-range";function Xe(t){return new Date(t.getFullYear(),t.getMonth(),t.getDate())}function Ze(t,e){const i=new Date(t);return i.setDate(i.getDate()+e),i}const Qe=t=>String(t).padStart(2,"0"),ti=t=>{const e=new Date(t);return`${Qe(e.getHours())}:${Qe(e.getMinutes())}`},ei=t=>t>0?String(Math.round(t/6e4)):"–";function ii(t){const e=/·\s*~?([\d.,]+)\s*L\s*$/.exec(t);return e?Number(e[1].replace(",",".")):null}function si(t){return("ran"===t.kind||"unplanned"===t.kind)&&0===t.liters}const ni="xt-irrigation-calendar-filter";function ai(t,e){try{return localStorage.getItem(t)??e}catch{return e}}function ri(t,e){try{localStorage.setItem(t,e)}catch{}}class oi extends dt{constructor(){super(...arguments),this._config=null,this._mode=["day","week","timeline"].includes(ai(Je,"day"))?ai(Je,"day"):"day",this._range=[1,3,7].includes(Number(ai(Ye,"1")))?Number(ai(Ye,"1")):1,this._anchor=Xe(new Date),this._events=[],this._problemsOnly=!1,this._filter=function(){try{return{...Pt,...JSON.parse(localStorage.getItem(ni)??"{}"),status:"all"}}catch{return Pt}}(),this._farm=yt,this._farmLoaded=!1,this._loading=!1,this._error=null,this._loadedKey=""}setConfig(t){this._config=t}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),this._timer=window.setInterval(()=>this._load(!0),3e5)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&window.clearInterval(this._timer)}updated(){!this._farmLoaded&&this.hass?.callApi&&(this._farmLoaded=!0,wt(this.hass).then(t=>this._farm=t,()=>{}));const t=`${this._mode}|${this._range}|${this._anchor.getTime()}`;t!==this._loadedKey&&this.hass?.callApi&&(this._loadedKey=t,this._load())}_window(){if("week"===this._mode){const t=function(t){const e=Xe(t);return e.setDate(e.getDate()-(e.getDay()+6)%7),e}(this._anchor);return[t,Ze(t,7)]}const t=Xe(this._anchor);return[t,Ze(t,"timeline"===this._mode?this._range:1)]}_valveByRegistry(){const t=new Map;for(const e of this._config?.valves??[])t.set(e.registry_entity,e);return t}async _load(t=!1){if(!this.hass?.callApi)return;const[e,i]=this._window(),s=`?start=${encodeURIComponent(e.toISOString())}&end=${encodeURIComponent(i.toISOString())}`,n=this._config?.planned_entity??"calendar.irrigation_planned",a=this._config?.completed_entity??"calendar.irrigation_completed";t||(this._loading=!0),this._error=null;try{const[t,e]=await Promise.all([this.hass.callApi("GET",`calendars/${n}${s}`),this.hass.callApi("GET",`calendars/${a}${s}`)]),i=this._valveByRegistry(),r=(t,e)=>{const s=Date.parse(t.start.dateTime??t.start.date??"");let n=Date.parse(t.end.dateTime??t.end.date??"");if(!Number.isFinite(s))return null;(!Number.isFinite(n)||n<=s)&&(n=s+6e4);const a=(t.uid??"").split("#")[0],r=i.get(a);return{start:s,end:n,kind:e,key:a,name:r?.valve_name??t.summary.split(" · ")[0],summary:t.summary,liters:"planned"===e?null:ii(t.summary),path:r?.view_path}},o=(e??[]).map(t=>r(t,/Type: In progress/.test(t.description??"")?"running":"ran")).filter(t=>!!t),l=(t??[]).map(t=>r(t,"planned")).filter(t=>!!t);this._events=St(l,o,Date.now())}catch(t){this._error=function(t){const e=t;return e?.body?.message??e?.message??String(t)}(t)}finally{this._loading=!1,t||this.updateComplete.then(()=>this._scrollToFirst())}}_scrollToFirst(){if("timeline"===this._mode)return;const[t,e]=this._window();let i=null;for(const s of this._events){if(s.end<=t.getTime()||s.start>=e.getTime())continue;const n=new Date(Math.max(s.start,t.getTime())),a=n.getHours()+n.getMinutes()/60;(null===i||a<i)&&(i=a)}const s=this.renderRoot.querySelector(".scroll");s&&null!==i&&(s.scrollTop=Math.max(0,(i-1)*this._hourPx()))}_hourPx(){return this._config?.hour_height??Math.max(36,Math.round(.72*window.innerHeight/8))}_setMode(t){this._mode=t,ri(Je,t)}_setRange(t){this._range=t,ri(Ye,String(t))}_shift(t){const e="week"===this._mode?7:"timeline"===this._mode?this._range:1;this._anchor=Ze(this._anchor,e*t)}_open(t){if(!t)return;const e=window.location.pathname.split("/")[1]||"lovelace";window.history.pushState(null,"",`/${e}/${t}`),this.dispatchEvent(new Event("location-changed",{bubbles:!0,composed:!0}))}_rangeLabel(){const[t,e]=this._window(),i={weekday:"short",day:"numeric",month:"short"};return e.getTime()-t.getTime()<=Ge?t.toLocaleDateString(void 0,i):`${t.toLocaleDateString(void 0,{day:"numeric",month:"short"})} – ${Ze(e,-1).toLocaleDateString(void 0,i)}`}_placeOf(t){const e=this._farm.locationOf[t.device_id],i=e?.site_id??null;return{site:i,siteName:i?Rt(this._farm.sites,i):null,mp:e?.name??null}}_visible(){const t=this._filter,e=t.site?Ut(this._farm.sites,t.site):null,i=t.search.trim().toLowerCase();return(this._config?.valves??[]).filter(t=>{const s=this._placeOf(t);return!!(!e||s.site&&e.has(s.site))&&(!i||[t.valve_name,s.mp,s.siteName].some(t=>t?.toLowerCase().includes(i)))})}_shownEvents(){if(!this._filter.site&&!this._filter.search.trim())return this._events;const t=new Set(this._visible().map(t=>t.registry_entity));return this._events.filter(e=>t.has(e.key))}_onFilter(t){this._filter=t.detail;try{localStorage.setItem(ni,JSON.stringify(t.detail))}catch{}}_legend(t){const e={planned:0,ran:0,missed:0,unplanned:0,running:0,dry:0};for(const i of t)e[i.kind]++,si(i)&&e.dry++;const i=(t,e,i,s)=>B`<span class="lg" title=${s}><i class="sw ${t}"></i><b>${e}</b> ${i}</span>`;return B`<div class="legend">
        ...
        <div class="head">
          ...
          <div class="bar">
            ...
            <div class="datenav">
              ...
              ${i(!1,"Today",()=>this._anchor=Xe(new Date))}
            </div>
          </div>
          <xt-valve-filter-bar
    ...
    `}_renderGrid(t){const[e]=this._window(),i="day"===this._mode?1:7,s=this._hourPx(),n=Xe(new Date).getTime();return B`
      <div class="scroll">
        <div class="grid" style="--hour:${s}px;--days:${i}">
          <div class="hours">
            ${i>1?B`<div class="colhead"></div>`:G}
            ${Array.from({length:24},(t,e)=>B`<div class="hour">${Qe(e)}:00</div>`)}
          </div>
          ${Array.from({length:i},(a,r)=>{const o=Ze(e,r).getTime(),l=o+Ge,d=t.filter(t=>t.start<l&&t.end>o).map(t=>({...t,start:Math.max(t.start,o),end:Math.min(Math.max(t.end,t.start+9e5),l)})),c=function(t){const e=[...t].sort((t,e)=>t.start-e.start||kt[t.kind]-kt[e.kind]||t.name.localeCompare(e.name)),i=[];let s=[],n=[],a=-1/0;const r=()=>{const t=s.length;for(const e of n)e.lanes=t;n=[],s=[]};for(const t of e){t.start>=a&&r();let e=s.findIndex(e=>e<=t.start);-1===e?(e=s.length,s.push(t.end)):s[e]=t.end;const o={ev:t,lane:e,lanes:0};n.push(o),i.push(o),a=Math.max(a,t.end)}return r(),i}(d),p=c.reduce((t,e)=>Math.max(t,e.lanes),1),u=i>1?40:72;return B`
              <div
                class="col ${o===n?"today":""}"
              ...
              >
                ...
                <div class="lines"></div>
                ${c.map(({ev:t,lane:e,lanes:i})=>{const n=(t.start-o)/Ke*s,a=Math.max((t.end-t.start)/Ke*s,s/4),r=100/i;return B`<div
    ...
    `}_renderTimeline(t){const[e,i]=this._window(),s=e.getTime(),n=i.getTime()-s,a=t=>(t-s)/n*100,r=Date.now(),o=new Map;for(const e of t)(o.get(e.key)??o.set(e.key,[]).get(e.key)).push(e);const l=this._visible(),d=t=>{const e=this._placeOf(t);return e.siteName??(e.mp?"No site":"No metering point")},c=new Map;for(const t of[...l].sort((t,e)=>d(t).localeCompare(d(e))||t.valve_name.localeCompare(e.valve_name)))(c.get(d(t))??c.set(d(t),[]).get(d(t))).push(t);const p=[...c.keys()],u=1===this._range?3:3===this._range?12:24,h=[];for(let t=s;t<i.getTime();t+=u*Ke){const e=new Date(t);h.push({left:a(t),label:u>=24||0===e.getHours()&&this._range>1?e.toLocaleDateString(void 0,{weekday:"short"}):`${Qe(e.getHours())}`})}const m=Array.from({length:this._range-1},(t,e)=>a(s+(e+1)*Ge)),v=r>s&&r<i.getTime()?a(r):null;let g=0;const f=p.map(t=>{const e=c.get(t).map(t=>{const e=o.get(t.registry_entity)??[],i=e.some(t=>"missed"===t.kind||"unplanned"===t.kind||t.end-t.start>144e5);return{v:t,evs:e,problem:i}}).filter(t=>!this._problemsOnly||t.problem);return e.length?(g+=e.length,B`
        ...
        ${e.map(({v:t,evs:e,problem:i})=>{const s=e.reduce((t,e)=>"planned"===e.kind||"missed"===e.kind?t+(e.end-e.start):null!=e.planStart&&null!=e.planEnd?t+(e.planEnd-e.planStart):t,0),n=e.filter(t=>"ran"===t.kind||"unplanned"===t.kind||"running"===t.kind),r=n.reduce((t,e)=>t+(e.end-e.start),0),o=n.reduce((t,e)=>null==e.liters?t:(t??0)+e.liters,null);return B`
            <div class="row clickable ${i?"problem":""}" @click=${()=>this._open(t.view_path)}>
              ...
              <div class="metric ${s?"":"muted"}">${ei(s)}</div>
              <div class="metric ${r?"":"muted"}">${ei(r)}</div>
  ...
  `],t([ht({attribute:!1})],oi.prototype,"hass",void 0),t([mt()],oi.prototype,"_config",void 0),t([mt()],oi.prototype,"_mode",void 0),t([mt()],oi.prototype,"_range",void 0),t([mt()],oi.prototype,"_anchor",void 0),t([mt()],oi.prototype,"_events",void 0),t([mt()],oi.prototype,"_problemsOnly",void 0),t([mt()],oi.prototype,"_filter",void 0),t([mt()],oi.prototype,"_farm",void 0),t([mt()],oi.prototype,"_loading",void 0),t([mt()],oi.prototype,"_error",void 0),!customElements.get("irrigation-calendar-card")){customElements.define("irrigation-calendar-card",oi);const t=window;t.customCards=t.customCards||[],t.customCards.some(t=>"irrigation-calendar-card"===t.type)||t.customCards.push({type:"irrigation-calendar-card",name:"Irrigation Calendar",description:"Planned, ran, missed and unplanned irrigation runs as a day grid, week grid or per-valve timeline."})}
