 ...
 */function ht(t){return ct({...t,state:!0,attribute:!1})}const pt="xtend_tuya/irrigation_locations";function ut(t){const e=t;return e?.body?.error??e?.body?.message??e?.error??e?.message??String(t)}function _t(t){if(!t)return"never";const e=Math.floor((Date.now()-new Date(t).getTime())/864e5);return e<=0?"today":1===e?"yesterday":e<60?`${e} days ago`:new Date(t).toLocaleDateString()}const $t=t=>new Date(t).toLocaleDateString(),mt=t=>null==t?"–":`${Math.round(t)} L`,vt=t=>""===t.trim()||isNaN(Number(t))?null:Number(t);class gt extends rt{constructor(){super(...arguments),this._config=null,this._data=null,this._loading=!1,this._error=null,this._query="",this._open=null,this._edit=null,this._confirmEnd=null,this._busy=!1,this._postError=null,this._newName=null,this._showUnassigned=!1,this._fetched=!1}setConfig(t){this._config=t}getCardSize(){return this._config?.device_id?1:this._config?.unassigned?3:8}async _load(){if(this.hass?.callApi){this._fetched=!0,this._loading=!0,this._error=null;try{this._data=await this.hass.callApi("GET",pt)}catch(t){this._error=ut(t)}finally{this._loading=!1}}}async _post(t,e){if(!this.hass?.callApi)return!1;this._busy=!0,this._postError=null;try{return await this.hass.callApi("POST",pt,e),await this._load(),!0}catch(e){return this._postError={key:t,msg:ut(e)},!1}finally{this._busy=!1}}_toggle(t){this._open=this._open===t?null:t,this._edit=null,this._confirmEnd=null,this._postError=null}_startEdit(t){const e=t=>null==t?"":String(t);this._edit={name:t.name,description:t.description??"",expected_lpm:e(t.expected_lpm),lat:e(t.lat),lon:e(t.lon)}}async _save(t){const e=this._edit;await this._post(t.id,{action:"update_location",id:t.id,name:e.name.trim(),description:e.description,expected_lpm:vt(e.expected_lpm),lat:vt(e.lat),lon:vt(e.lon)})&&(this._edit=null)}async _create(){const t=(this._newName??"").trim();t&&await this._post("new",{action:"create_location",name:t})&&(this._newName=null)}_matches(t,e){if(!e)return!0;const i=[t.name,...t.devices.flatMap(t=>[t.number??"",t.valve_name??""])];return i.some(t=>t.toLowerCase().includes(e))}_chip(t){return q`<span class="chip" title=${t.valve_name??t.device_id}
    ...
    /></label>`;return q`<div class="details">
    ...
    </ha-card>`:V}_renderDevice(t){const e=this._data,i=e?.locations.find(e=>e.devices.some(e=>e.device_id===t&&!e.end))??null,s=e?q`<select ?disabled=${this._busy} @change=${e=>{const i=e.target,s=i.value;i.value="",s&&this._post("device",{action:"assign_device",device_id:t,location_id:s})}}>
          <option value="">${i?"Move to…":"Assign to…"}</option>
          ${e.locations.filter(t=>t.id!==i?.id).map(t=>q`<option value=${t.id}>${t.name}</option>`)}
      ...
      <div class="card-content">
        ...
        <div class="hist">
          <div class="hist-main">${i?q`<b>${i.name}</b>`:q`<span class="dim">Not assigned</span>`}</div>
          ${s}
        </div>
        ${this._errFor("device")}
      </div>
