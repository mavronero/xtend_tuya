 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const A=globalThis,w=t=>t,x=A.trustedTypes,E=x?x.createPolicy("lit-html",{createHTML:t=>t}):void 0,S="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,P="?"+C,U=`<${P}>`,N=document,k=()=>N.createComment(""),O=t=>null===t||"object"!=typeof t&&"function"!=typeof t,M=Array.isArray,R="[ \t\n\f\r]",T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,H=/-->/g,L=/>/g,D=RegExp(`>|${R}(?:([^\\s"'>=/]+)(${R}*=${R}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),z=/'/g,j=/"/g,I=/^(?:script|style|textarea|title)$/i,q=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),B=Symbol.for("lit-noChange"),V=Symbol.for("lit-nothing"),W=new WeakMap,F=N.createTreeWalker(N,129);function G(t,e){if(!M(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==E?E.createHTML(e):e}const J=(t,e)=>{const i=t.length-1,s=[];let n,o=2===e?"<svg>":3===e?"<math>":"",r=T;for(let e=0;e<i;e++){const i=t[e];let a,l,d=-1,c=0;for(;c<i.length&&(r.lastIndex=c,l=r.exec(i),null!==l);)c=r.lastIndex,r===T?"!--"===l[1]?r=H:void 0!==l[1]?r=L:void 0!==l[2]?(I.test(l[2])&&(n=RegExp("</"+l[2],"g")),r=D):void 0!==l[3]&&(r=D):r===D?">"===l[0]?(r=n??T,d=-1):void 0===l[1]?d=-2:(d=r.lastIndex-l[2].length,a=l[1],r=void 0===l[3]?D:'"'===l[3]?j:z):r===j||r===z?r=D:r===H||r===L?r=T:(r=D,n=void 0);const h=r===D&&t[e+1].startsWith("/>")?" ":"";o+=r===T?i+U:d>=0?(s.push(a),i.slice(0,d)+S+i.slice(d)+C+h):i+C+(-2===d?e:h)}return[G(t,o+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),s]};class K{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let n=0,o=0;const r=t.length-1,a=this.parts,[l,d]=J(t,e);if(this.el=K.createElement(l,i),F.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(s=F.nextNode())&&a.length<r;){if(1===s.nodeType){if(s.hasAttributes())for(const t of s.getAttributeNames())if(t.endsWith(S)){const e=d[o++],i=s.getAttribute(t).split(C),r=/([.?@])?(.*)/.exec(e);a.push({type:1,index:n,name:r[2],strings:i,ctor:"."===r[1]?tt:"?"===r[1]?et:"@"===r[1]?it:X}),s.removeAttribute(t)}else t.startsWith(C)&&(a.push({type:6,index:n}),s.removeAttribute(t));if(I.test(s.tagName)){const t=s.textContent.split(C),e=t.length-1;if(e>0){s.textContent=x?x.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],k()),F.nextNode(),a.push({type:2,index:++n});s.append(t[e],k())}}}else if(8===s.nodeType)if(s.data===P)a.push({type:2,index:n});else{let t=-1;for(;-1!==(t=s.data.indexOf(C,t+1));)a.push({type:7,index:n}),t+=C.length-1}n++}}static createElement(t,e){const i=N.createElement("template");return i.innerHTML=t,i}}function Z(t,e,i=t,s){if(e===B)return e;let n=void 0!==s?i._$Co?.[s]:i._$Cl;const o=O(e)?void 0:e._$litDirective$;return n?.constructor!==o&&(n?._$AO?.(!1),void 0===o?n=void 0:(n=new o(t),n._$AT(t,i,s)),void 0!==s?(i._$Co??=[])[s]=n:i._$Cl=n),void 0!==n&&(e=Z(t,n._$AS(t,e.values),n,s)),e}class Y{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,s=(t?.creationScope??N).importNode(e,!0);F.currentNode=s;let n=F.nextNode(),o=0,r=0,a=i[0];for(;void 0!==a;){if(o===a.index){let e;2===a.type?e=new Q(n,n.nextSibling,this,t):1===a.type?e=new a.ctor(n,a.name,a.strings,this,t):6===a.type&&(e=new st(n,this,t)),this._$AV.push(e),a=i[++r]}o!==a?.index&&(n=F.nextNode(),o++)}return F.currentNode=N,s}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class Q{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,s){this.type=2,this._$AH=V,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Z(this,t,e),O(t)?t===V||null==t||""===t?(this._$AH!==V&&this._$AR(),this._$AH=V):t!==this._$AH&&t!==B&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>M(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==V&&O(this._$AH)?this._$AA.nextSibling.data=t:this.T(N.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,s="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=K.createElement(G(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(e);else{const t=new Y(s,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=W.get(t.strings);return void 0===e&&W.set(t.strings,e=new K(t)),e}k(t){M(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const n of t)s===e.length?e.push(i=new Q(this.O(k()),this.O(k()),this,this.options)):i=e[s],i._$AI(n),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=w(t).nextSibling;w(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class X{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,s,n){this.type=1,this._$AH=V,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=n,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=V}_$AI(t,e=this,i,s){const n=this.strings;let o=!1;if(void 0===n)t=Z(this,t,e,0),o=!O(t)||t!==this._$AH&&t!==B,o&&(this._$AH=t);else{const s=t;let r,a;for(t=n[0],r=0;r<n.length-1;r++)a=Z(this,s[i+r],e,r),a===B&&(a=this._$AH[r]),o||=!O(a)||a!==this._$AH[r],a===V?t=V:t!==V&&(t+=(a??"")+n[r+1]),this._$AH[r]=a}o&&!s&&this.j(t)}j(t){t===V?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class tt extends X{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===V?void 0:t}}class et extends X{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==V)}}class it extends X{constructor(t,e,i,s,n){super(t,e,i,s,n),this.type=5}_$AI(t,e=this){if((t=Z(this,t,e,0)??V)===B)return;const i=this._$AH,s=t===V&&i!==V||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==V&&(i===V||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class st{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Z(this,t)}}const nt=A.litHtmlPolyfillSupport;nt?.(K,Q),(A.litHtmlVersions??=[]).push("3.3.2");const ot=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function ht(t){return ct({...t,state:!0,attribute:!1})}const pt="xtend_tuya/irrigation_locations";function ut(t){const e=t;return e?.body?.error??e?.body?.message??e?.error??e?.message??String(t)}function _t(t){if(!t)return"never";const e=Math.floor((Date.now()-new Date(t).getTime())/864e5);return e<=0?"today":1===e?"yesterday":e<60?`${e} days ago`:new Date(t).toLocaleDateString()}const $t=t=>new Date(t).toLocaleDateString(),vt=t=>null==t?"–":`${Math.round(t)} L`,mt=t=>""===t.trim()||isNaN(Number(t))?null:Number(t);class gt extends rt{constructor(){super(...arguments),this._config=null,this._data=null,this._loading=!1,this._error=null,this._query="",this._open=null,this._edit=null,this._confirmEnd=null,this._busy=!1,this._postError=null,this._newName=null,this._showUnassigned=!1,this._fetched=!1}setConfig(t){this._config=t}getCardSize(){return this._config?.device_id?1:this._config?.unassigned?3:8}async _load(){if(this.hass?.callApi){this._fetched=!0,this._loading=!0,this._error=null;try{this._data=await this.hass.callApi("GET",pt)}catch(t){this._error=ut(t)}finally{this._loading=!1}}}async _post(t,e){if(!this.hass?.callApi)return!1;this._busy=!0,this._postError=null;try{return await this.hass.callApi("POST",pt,e),await this._load(),!0}catch(e){return this._postError={key:t,msg:ut(e)},!1}finally{this._busy=!1}}_toggle(t){this._open=this._open===t?null:t,this._edit=null,this._confirmEnd=null,this._postError=null}_startEdit(t){const e=t=>null==t?"":String(t);this._edit={name:t.name,description:t.description??"",expected_lpm:e(t.expected_lpm),lat:e(t.lat),lon:e(t.lon)}}async _save(t){const e=this._edit;await this._post(t.id,{action:"update_location",id:t.id,name:e.name.trim(),description:e.description,expected_lpm:mt(e.expected_lpm),lat:mt(e.lat),lon:mt(e.lon)})&&(this._edit=null)}async _create(){const t=(this._newName??"").trim();t&&await this._post("new",{action:"create_location",name:t})&&(this._newName=null)}_matches(t,e){if(!e)return!0;const i=[t.name,...t.devices.flatMap(t=>[t.number??"",t.valve_name??""])];return i.some(t=>t.toLowerCase().includes(e))}_chip(t){return q`<span class="chip" title=${t.valve_name??t.device_id}
    ...
    </select>`}_errFor(t){return this._postError?.key===t?q`<div class="err">${this._postError.msg}</div>`:V}_details(t){const e=this._edit,i=(t,i,s="text")=>q`<label
      >${i}<input
        type=${s}
        step="any"
        .value=${e[t]}
    ...
    /></label>`;return q`<div class="details">
      ${e?q`<div class="form">
            ...
            <div class="actions">
              ...
              <dt>Last run</dt>
              <dd>${_t(t.stats.last_run_end)}${null!=t.stats.last_run_liters?` · ${vt(t.stats.last_run_liters)}`:""}</dd>
              <dt>Runs</dt>
      ...
      ${0===t.devices.length?q`<div class="dim">No devices yet.</div>`:V}
      ${t.devices.map(e=>q`<div class="hist">
          ...
          <div class="hist-meta">
            ...
            · ${e.source}
            ${e.end?V:this._confirmEnd===e.device_id?q`<span class="confirm"
                    >End here?
                    <button
                      ?disabled=${this._busy}
      ...
      <div class="row" @click=${()=>this._toggle(t.id)}>
        ...
        <div class="row-meta">
          ...
          <span>${vt(e.liters_7d)} 7d · ${vt(e.liters_30d)} 30d</span>
          ${null!=t.expected_lpm&&null!=e.avg_lpm_30d?q`<span>${e.avg_lpm_30d.toFixed(1)} of ${t.expected_lpm} L/min expected</span>`:V}
        </div>
      </div>
      ${s?this._details(t):V}
    ...
    </ha-card>`:V}_renderDevice(t){const e=this._data,i=e=>e.device_id===t||e.ha_device_id===t,s=e?.locations.find(t=>t.devices.some(t=>i(t)&&!t.end))??null,n=s?.devices.find(t=>i(t))?.device_id??e?.unassigned.find(t=>i(t))?.device_id??t,o=e?q`<select ?disabled=${this._busy} @change=${t=>{const e=t.target,i=e.value;e.value="",i&&this._post("device",{action:"assign_device",device_id:n,location_id:i})}}>
          <option value="">${s?"Move to…":"Assign to…"}</option>
          ${e.locations.filter(t=>t.id!==s?.id).map(t=>q`<option value=${t.id}>${t.name}</option>`)}
        </select>`:V;return q`<ha-card>
      <div class="card-header">
        <ha-icon icon="mdi:map-marker-radius"></ha-icon>
        <span class="title">${this._config.title??"Location"}</span>
      </div>
      <div class="card-content">
        ${this._error?q`<div class="err">${this._error}</div>`:V}
        <div class="hist">
    ...
    </ha-card>`}render(){if(!this._config||!this.hass)return V;if(this._fetched||this._load(),this._config.device_id)return this._renderDevice(this._config.device_id);if(this._config.unassigned)return this._renderUnassigned();const t=this._data,e=this._query.trim().toLowerCase(),i=t?t.locations.filter(t=>this._matches(t,e)):[];return q`<ha-card>
      <div class="card-header">
        <ha-icon icon="mdi:map-marker-radius"></ha-icon>
      ...
      <div class="card-content">
        ...
        />
        ${this._error?q`<div class="err">Could not load locations: ${this._error}</div>`:V}
        ${!t&&this._loading?q`<div class="dim">Loading…</div>`:V}
        ${t&&0===i.length?q`<div class="dim">No locations match.</div>`:V}
        ${i.map(t=>this._row(t))}
        ${t?q`<div class="unassigned">
              ...
              ${this._showUnassigned?this._unassignedRows(t):V}
            </div>`:V}
      </div>
    </ha-card>`}}if(gt.styles=((t,...e)=>{const i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new o(i,t,s)})`
    :host {
  ...
  `,t([ct({attribute:!1})],gt.prototype,"hass",void 0),t([ht()],gt.prototype,"_config",void 0),t([ht()],gt.prototype,"_data",void 0),t([ht()],gt.prototype,"_loading",void 0),t([ht()],gt.prototype,"_error",void 0),t([ht()],gt.prototype,"_query",void 0),t([ht()],gt.prototype,"_open",void 0),t([ht()],gt.prototype,"_edit",void 0),t([ht()],gt.prototype,"_confirmEnd",void 0),t([ht()],gt.prototype,"_busy",void 0),t([ht()],gt.prototype,"_postError",void 0),t([ht()],gt.prototype,"_newName",void 0),t([ht()],gt.prototype,"_showUnassigned",void 0),!customElements.get("irrigation-locations-card")){customElements.define("irrigation-locations-card",gt);const t=window;t.customCards=t.customCards||[],t.customCards.some(t=>"irrigation-locations-card"===t.type)||t.customCards.push({type:"irrigation-locations-card",name:"Irrigation Locations",description:"Irrigation locations with their installed valves, watering history and device assignments."})}export{gt as IrrigationLocationsCard};
