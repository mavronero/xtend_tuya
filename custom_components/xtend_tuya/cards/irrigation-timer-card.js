      ...
      <div class="timer-row ${t.enabled?"":"disabled"}">
        <div class="timer-info" @click=${()=>this._startEdit(t)}>
          ...
          <div class="timer-time">
            ${e}<span class="timer-value" title=${t.mode===pt.Duration?"Duration":"Volume"}>
              · ${i}</span
            >
          </div>
